...
//	$obj_filter = $this->filter;
	...
	JToolBarHelper::publish('list.MDpublish');
	JToolBarHelper::unpublish('list.MDunpublish');
	JToolBarHelper::customX('translatemodules.edit','translate','','Translate');
	
	JToolBarHelper::deleteList("Are you sure?",'list.removeMD');
...
<div id="tablecell">
	...
	{
		$row = &$this->rows[$i];
		$published 	= JHTML::_('grid.published', $row, $i, 'publish_g.png','publish_x.png','list.MD' );
	?>

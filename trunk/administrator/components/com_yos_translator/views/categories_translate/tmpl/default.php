...
function submitbutton(pressbutton)
{
	...
	if ( pressbutton == 'cancel') {
		submitform('translatecategories.cancel');
	}
...
function ajax_translate(i, n){
	if (i<n) {
		...
		url="index.php?option=com_yos_translator&tmpl=component&task=translatecategories.save&id="+id+"&src="+document.adminForm.default_l.value+"&dst="+document.adminForm.language_id.value+"&published="+$('published').checked;
		var log = $('log_res'+i);
		log.removeClass('yos_completed');

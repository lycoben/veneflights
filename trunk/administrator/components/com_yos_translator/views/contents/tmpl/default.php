...
<div id="tablecell">
	...
	{
		$row = &$this->rows[$i];
		$published 	= JHTML::_('grid.published', $row, $i, 'publish_g.png','publish_x.png','list.' );
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td align="left">
			<span class="editlinktip hasTip" title="<?php echo JText::_( 'Translate Content' );?>::<?php echo $row->title; ?>">
				<a href="index.php?option=<?php echo $option; ?>&task=translateone.edit&cid[]=<?php echo $row->id; ?>|<?php echo $row->language_id ? $row->language_id : 'NULL'; ?>"><?php echo $row->title;?></a>
			</span>
			</td>
			<td align="center">
				<?php echo $row->name; ?>

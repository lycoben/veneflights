...
define ('_UDDEIM_NOMESSAGES_INBOX', '<strong>Няма съобщения.</strong>');
define ('_UDDEIM_NOMESSAGES_OUTBOX', '<strong>Няма съобщения.</strong>');
define ('_UDDEIM_NOMESSAGES_TRASHCAN', '<strong>Няма съобщения.</strong>');
...
define ('_UDDEADM_NOCB', '<span style="color: red;">Не сте инсталирали Mambo Community Builder. Няма да може да ползвате uddeIM.</span><br /><br />You might want to download <a href="http://www.mambojoe.com">Mambo Community Builder</a>.');

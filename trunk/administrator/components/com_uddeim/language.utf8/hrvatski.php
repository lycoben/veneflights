...
DEFINE ('_UDDEADM_MAINTENANCE_EXP', 'Kad je korisnik izbrisan iz baze podataka, negove poruke su obično sačuvane u bazi podataka. Ova funkcija provjerava da li je potrebno brisati poruke koje nikome ne pripadaju, a možete ih i izbrisati akot to želite.');
...
DEFINE ('_UDDEADM_MAINTENANCE_NOTFOUND', '<b>#$i nije pronađeno (od/za): $mvon/$man</b><br />');
...
DEFINE ('_UDDEIM_TRASHCAN_INFO', 'Poruke će brije brisanja ostati u smeću 24 sata. Možete vidjeti samo prve riječi poruke. Ako želite pročitati cijelu poruku, morate ju prvo obnoviti.');
...
DEFINE ('_UDDEIM_COULDNOTRESTORE', 'Neuspjelo vraćanje poruke u prijašnje stanje.');
...
DEFINE ('_UDDEIM_NOMESSAGES_TRASHCAN', '<strong>Nemate poruka u smeću.</strong>');
...
DEFINE ('_UDDEIM_READSTATUS', 'Čitaj');
...
DEFINE ('_UDDEIM_DELETEREPLIED', 'Nakon odgovora premjesti originalnu poruku u smeće');
...
DEFINE ('_UDDEADM_GENERAL', 'Općenito');
...
DEFINE ('_UDDEADM_ADMINIGNITIONONLY_EXP', 'Automatsko brisanje opterećuje servere i baze podataka. Ako izaberete <i>Da,&nbsp;samo&nbsp;administratori</i>, automatsko brisanje prema postavkama (poruke svih korisnika) vrši se kad bilo koji administrator provjeri svoju ulaznu poštu. Izaberite ovu opciju ako administrator provjerava svoju ulaznu poštu jednom dnevno ili češće, što je slučaj s većim brojem web stranica. (Ako vaše stranice imaju više od jednog administratora, nije bitno tko se od njih prijavi jer brisanje se pokreće automatski, od strane bilo kojeg administratora.) Za manje web stranice ili stranice koje se rijetko administriraju i na kojima administrator rijetko provjerava ulaznu poštu, izaberite <i>ne,&nbsp;bilo&nbsp;koji&korisnik</i>. Ako sve ovo ne razumijete ili ne znate što učiniti, izaberite <i>ne, bilo koji korisnik</i>.');
	// above string changed in 0.4 
DEFINE ('_UDDEADM_SAVESETTINGS', 'Sačuvaj postavke');
DEFINE ('_UDDEADM_THISHASBEENSAVED', 'Slijedeće postavke sačuvane su u datoteki konfiguracije:');
DEFINE ('_UDDEADM_SETTINGSSAVED', 'Postavke su spremljene.');
DEFINE ('_UDDEADM_ICONONLINEPIC_HEAD', 'Ikona: Korisnik je online');
DEFINE ('_UDDEADM_ICONONLINEPIC_EXP', 'Upišite lokaciju ikone koja će biti prikazana pored korisničkog imena kad je korisnik online.');
DEFINE ('_UDDEADM_ICONOFFLINEPIC_HEAD', 'Ikona: Korisnik je offline');
DEFINE ('_UDDEADM_ICONOFFLINEPIC_EXP', 'Upišite lokaciju ikone koja će se prikazati pored korisničkog imena kad je korisnik offline.');
DEFINE ('_UDDEADM_ICONREADPIC_HEAD', 'Ikona: Pročitaj poruku');
DEFINE ('_UDDEADM_ICONREADPIC_EXP', 'Upišite lokaciju ikone koja će se prikazati za čitanje poruka.');
DEFINE ('_UDDEADM_ICONUNREADPIC_HEAD', 'Ikona: Nepročitana poruka');
DEFINE ('_UDDEADM_ICONUNREADPIC_EXP', 'Upišite lokaciju ikone koja će se prikazati za nepročitane poruke.');
DEFINE ('_UDDEADM_MODULENEWMESS_HEAD', 'Modul: Ikona novih poruka');
DEFINE ('_UDDEADM_MODULENEWMESS_EXP', 'Ova postavka odnosi se na mod_uddeim_new modul. Upišite lokaciju ikone koju će ovaj modul prikazati kada ima novih poruka.');

// admin import tab

DEFINE ('_UDDEADM_UDDEINSTALL', 'uddeIM Instalacija');
DEFINE ('_UDDEADM_FINISHED', 'Instalacija završena. Dobrodošli u uddeIM 0.7 (beta). ');
DEFINE ('_UDDEADM_NOCB', '<span style="color: red;">Niste instalirali Community Builder. Nećete moći koristiti uddeIM.</span><br /><br />Preuzmite <a href="http://www.mambojoe.com">Community Builder</a>.');
...
DEFINE ('_UDDEADM_IMPORT_EXP', 'Ovo neće promjeniti myPMS poruke ili vašu instalaciju. Poruke će biti neoštećene. Možete ih bez problema importirati u uddeIM, čak i ako mislite i dalje koristiti myPMS. (Prije importiranja trebali bi ste prvo sačuvati promjene koje ste napravili u postavkama!) Ako već imate poruka u vašoj uddeIM bazi podataka, one će ostati neoštećene.');
...
DEFINE ('_UDDEADM_SHOWCBLINK_EXP', 'Kad je postavljeno na <i>da</i>, sva korisnička imena koja se pojavljuju u uddeIM biti će prikazana kao link za njihov Community Builder profil.');
DEFINE ('_UDDEADM_SHOWCBPIC_HEAD', 'Prikaži CB thumbnail');
DEFINE ('_UDDEADM_SHOWCBPIC_EXP', 'Kad je postavljeno na <i>da</i>, korisnikov thumbnail bit će prikazan prilikom čitanja poruke (ako on(a) ima sliku u svom Community Builder profilu).');
...
ska, ovdje možete upisati set znakova (charset) kojeg će uddeIM koristiti za prikazivanje informacija iz baze podataka u HTML kodu. <b>Ako ne znate što to znači, nemojte mjenjati postavljenu vrijednost!</b>');
DEFINE ('_UDDEADM_MAILCHARSET_HEAD', 'Znakovi u upotrebi za mail');
DEFINE ('_UDDEADM_MAILCHARSET_EXP', 'Ako imate problema s prikazivanjem slova koja nisu latin1, ovdje možete upisati set znakova (charset) kojeg će uddeIM koristiti za slanje izlazne pošte. <b>Ako ne znate što to znači, nemojte mjenjati postavljenu vrijednost!</b>');
...
DEFINE ('_UDDEIM_WRITE_NORMAL', '[Kreiraj običnu poruku]');
...
DEFINE ('_UDDEIM_EMNOFF', 'E-mail obavijest je isključena. ');
DEFINE ('_UDDEIM_EMNON', 'E-mail obavijest je uključena. ');
...
Molimo vas da se prijavite na stranice i pročitate je!');
...
imate nepročitane poruke na %site%.
Molimo vas da se prijavite na stranice i pročitate ih!
');
...
DEFINE ('_UDDEADM_SHOWSETTINGSLINK_EXP', 'Link za postavke pojaviti će se u uddeIM ako imate aktivirane e-mail obavijesti ili sistem blokiranja. Ako to ne želite, isključite opciju. ');

...
DEFINE ('_UDDEADM_REVIEWUPDATE', 'Fontos: Ha az uddeIM-et egy korábbi verzióról frissítjük, feltétlenül ellenõrízzük a README fájlt! Elõfordulhat ugyanis, hogy adatbázis táblákat vagy mezõket kell felvennünk vagy módosítanunk!');
...
"Hello %user%,\n\n%you% a következõ privát üzenetet küldte a %site% szájtról.\n__________________\n%pmessage%");
...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Felkapcsolódik az uddeIM fejlesztõi weboldalára, a jelenlegi legfrissebb verzió ellenörzéséért. Az uddeIM verzión kívül semmi más adat (semmilyen személyes adat sem!) nem kerül tövábbításra.');
...
DEFINE ('_UDDEIM_MESSAGENOACCESS', 'ez az üzenet nme jeleníthetõ meg. <br />Lehetséges okok:<ul><li>Nincsen jogod elolvasni ezt az üzenetet</li><li>Az üzenetet törölték</li></ul>');
...
DEFINE ('_UDDEADM_SHOWCBPIC_EXP', 'Ha <i>igen</i>-re állítjuk, az üzenet olvasásakor a feladó mezõben megjelenik a feladó CB avatárképe.');
...
DEFINE ('_UDDEADM_EMAILWITHMESSAGE_EXP', 'Ha <i>nem</i>-re állítjuk, az email csak értesít minket új üzenet érkezésérõl, de maga az üzenet enm fog szerepelni benne.');

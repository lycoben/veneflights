...
DEFINE ('_UDDEADM_VERSIONCHECK_EXP', 'Hiermit kontaktieren sie die uddeIM Entwicklerwebsite, um Informationen über die aktuelle Version zu erhalten. Außer der Versionsnummer werden keine weiteren persönlichen Daten übertragen.');
...
// Old: 0.5
define ('_UDDEIM_TRASHCAN_INFO', 'Nachrichten befinden sich 24 Stunden im Papierkorb und werden dann endgültig gelöscht. Sie sehen nur die ersten paar Worte. Um die ganze Nachricht lesen zu können, müssen sie sie erst wieder herstellen.');
...
define ('_UDDEADM_ICONREADPIC_EXP', 'Geben sie hier den Ort des Bildes an, das für <b>gelesene</b> Nachrichten angezeigt wird');
define ('_UDDEADM_ICONUNREADPIC_HEAD', 'Icon: Ungelesene Nachricht');
define ('_UDDEADM_ICONUNREADPIC_EXP', 'Geben sie hier den Ort des Bildes an, das für <b>ungelesene</b> Nachrichten angezeigt wird');
...
DEFINE ('_UDDEADM_NOCB', '<span style="color: red;">Sie haben den Community Builder nicht installiert. Sie können uddeIM daher nicht nutzen!</span><br /><br />Sie können den <a href="http://www.mambojoe.com">Mambo Community Builder</a> installieren.');
...
"Hallo %you%,\n\nauf %site% gibt es neue private Nachrichten für sie. Bitte loggen sie sich ein, um sie zu lesen!");
...
DEFINE ('_UDDEIM_ARC_CANSAVEMAX_1', 'Sie können maximal ');
...
DEFINE ('_UDDEIM_EXPORT_MAIL_INTRO', 'Die E-Mail enthält ihre privaten Nachrichten.');

...
<?php endif; ?>
	...
	<input type="hidden" name="return-url" value="<?php echo base64_encode('index.php?option=com_yos_ammap&task=addon&folder='.$this->state->folder); ?>" />
	<input type="hidden" name="oldtask" value="addon" />
	<input type="hidden" name="folder" value="<?echo $this->state->folder; ?>" />
</form>
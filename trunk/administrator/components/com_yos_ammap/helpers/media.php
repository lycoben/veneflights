...
class MediaHelper
{
	...
	{
		$params = &JComponentHelper::getParams( 'com_yos_ammap' );
		
		if (!$params->get('upload_extensions')) {
			$components	=	&JComponentHelper::getComponent('com_yos_ammap');
	...
	function checkammap(){
		jimport('joomla.filesystem.file');
		if (!JFile::exists(JPATH_SITE.DS.'components'.DS.'com_yos_ammap'.DS.'ammap'.DS.'ammap.swf')) {

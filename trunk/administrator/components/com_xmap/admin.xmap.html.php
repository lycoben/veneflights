<?php 
/**
 * $Id: admin.xmap.html.php 139 2008-04-05 18:51:03Z root $
...
class XmapAdminHtml {
	...
	function show ( &$config, &$menus, &$lists, &$pluginList, &$xmlfile ) {
		...
		$mainframe->addCustomHeadTag("<link type=\"text/css\" rel=\"stylesheet\"  href=\"$xmapComponentURL/admin1.css\" />");	
...
<?php
       ...
       ?> 
		...
		if (typeof addSitemap != 'function') {
			...
			document.write('<' + 'link href="<?php echo $xmapAdministratorURL; ?>/components/com_xmap/admin1.css" rel="stylesheet" type="text/css"' + ' />');
		}
		</script>
		<?php
	}

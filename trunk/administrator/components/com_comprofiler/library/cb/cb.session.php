...
* @author Beat
* @copyright (C) 2008 Beat, www.joomlapolis.com
	...
	function & connect() {
		if ( ! $this->_db ) {
			...
			if ( $_CB_database ) {
				...
				$config						=	file_get_contents( dirname( __FILE__ ) . '/../../../../../configuration.php' );
...
class CBSession {
	...
	function _sendSessionCookies() {
		return CBCookie::setcookie( $this->_cookie_name, $this->_session_id, false, null, null, null, true );
	}
	/**

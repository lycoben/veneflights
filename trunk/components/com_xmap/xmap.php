...
if ($xSitemap->usecache) {
	$lang = JFactory::getLanguage();
	$xmapCache->call('xmapCallShowSitemap',$view,$xSitemap->id,$excluded_items,$lang->getName(),$mainframe->getCfg('sef'),$user->get('id'));	// call plugin's handler function
} else {
...
*/
function xmapCallShowSitemap($view,$sitemapid,$excluded_items,$locale='',$sef='',$userid=0) {

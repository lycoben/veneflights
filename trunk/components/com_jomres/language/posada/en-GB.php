...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMSCONFIGDESC','Rooms/posada Configuration');

/**
* @ignore
*/
define('_JOMRES_COM_MR_posadaCONFIGDESC','posada Configuration');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMCLASS','New room/posada type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWposada','New posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWposadaFEATURE','New posada feature');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL','Default posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_CHANGEHOTEL','Change posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN','posada manager');
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Room/posada type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Room/posada type description');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_TITLE','Quick Res select room/posada types');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the room/posada type required, the arrival date of the guest and either the number of nights the guest is staying or their departure date. Finally, enter the number of adults & children in the contingent.');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_posadaNAME','posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Room/posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_NOROOMSINRANGE','<font color="red" face="arial" size="3">Sorry, the posada can not offer accommodation for this period. Please return to the calendars and review the availability displayed there.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ERROR_NOROOMTYPESSELECTED','<font color="red" face="arial" size="4">ERROR: You did not select any room/posada types.<br>Press the back button & re-enter your data.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VIEWROOMSposadaCONFIG_TITLE','View rooms & posada config');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_posadaS','posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_posadaFEATURES','Prop feats');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_posada','posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Room/posada type abbreviation');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Room/posada type description');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Room/posada type added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Room/posada type updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_LINK','posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_NAME','Name');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_STREET','Street');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_TOWN','Town');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_REGION','Region');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_COUNTRY','Country');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_POSTCODE','Postcode');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_TELEPHONE','Tel');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_FAX','Fax');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_EMAIL','Email');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_WEBSITE','Website');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_FEATURES','Features');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_CLICKTOEDIT','Click the posada uid link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_SAVE_INSERT','posada added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_SAVE_UPDATE','posada updated');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_LINKTEXT','Edit item');

/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_HEADER_LINK','posada Features');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_ABBV','posada feature abbv.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_HEADER_DESC','posada feature full description');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_CLICKTOEDIT','Click the posada feature uid link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_SAVE_INSERT','posada feature added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_SAVE_UPDATE','posada feature updated');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posadaFEATURES_LINKTEXT','Edit item');
...
* @ignore
*/
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Room/posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_posadaADMIN','posada admin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the room/posada type required, your arrival date and the number of nights you will be staying. Finally, enter the number of adults & children in the contingent.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_TITLE','Select room/posada types');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Booking made for posada: ');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_OPTIN','Opt into jomres network?');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_OPTIN_DESC','If you choose to opt this posada into the jomres network, then it will be listed at jomres.net. Please note, it will be assumed that this is a live hotel. Jomres.net cannot be held responsible for your posada. You must ensure that your details are correct.');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_CHOOSEposada','Choose the posada you want room availability information on');

/**
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_ANYposada','Any');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_posada','posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_posadaFEATURE_DELETE','Delete posada feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_posadaFEATURE_UNABLETODELETE','Unable to remove this posada feature, it is assigned to a posada. Remove the feature from this posada and retry.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_posadaFEATURE_DELETED','posada feature deleted');

/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete room/posada type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this room/posada type, it is assigned to a room. Try re-assigning the room to another room/posada type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this room/posada type, it is assigned to a tariff. Try re-assigning the tariff to another room/posada type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Room/posada type deleted');

/**
* @ignore
*/
define('_JOMRES_COM_MR_posada_DELETE','Delete posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_posada_UNABLETODELETE_MESSAGE','Unable to remove this posada, it has data in table: ');
/**
* @ignore
*/
define('_JOMRES_COM_MR_posada_DELETED','posada deleted');
/**
* @ignore
*/
define('_JOMRES_COM_MR_posada_DELETE_NORIGHTS','You do not have rights to delete this posada.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISposada_BUTTON','Choose this posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISposada_DESC','Which posada will your room be associated with?');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_SELECTposada','Select a posada');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_MUSTSELECTposada','You must select a posada');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_MAPPINGLINK','Click for a map');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_PROPDESCRIPTION','posada description');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_CHECKINTIMES','Check in times');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_AREAACTIVITIES','Area activities');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_DRIVINGDIRECTIONS','Driving directions');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_AIRPORTS','Airports');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_OTHERTRANSPORT','Other transport');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_POLICIESDISCLAIMERS','Policies & disclaimers');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_posadaKEY','Your Jomres.net posada key');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_posadaKEY_DESC','When you are ready to put your website up on the web, visit <a href="http://www.jomres.net" target="_blank">Jomres.net</a> for your posada key. With that jomres can register your posada on the Jomres Network, ensuring that your reach the widest possible audience for your business.');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_OURPROPERTIES','Our posadas');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_THISposadaADDRESS','Address');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMposada','Is this an apartment/cottage/villa?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMposada_DESC','EG you are renting out a posada, rather than rooms in that posada. If this is the case, then you must make sure that you only have the one room registered against each posada.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when posada/room is available');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_LISTING_posada','posada rights');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_LISTING_posadaRIGHTS',' ');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_LISTING_GLOBAL_posadaRIGHTS','<b>Any</b>');
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_posada','Created posada');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_posada','Updated posada');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_posada','Deleted posada');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_posada_FEATURE','Created prop. feature');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_posada_FEATURE','Updated prop. feature');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_posada_FEATURE','Deleted prop. feature');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_EDIT_posada_SETTINGS','Edited prop. settings');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_PUBLISH_posada','Published prop.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_posada_IMAGE','Uploaded new prop image');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_posada_IMAGE','Uploaded diff. prop image');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BUTTON','Select this posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_posada_HEADER_STARS','Number of stars');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES','Show room/posada types?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES_DESC','Set this to Yes to show room/posada types?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Room/posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PTYPE','posada type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_LIST_TITLE','List posada types');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_LIST_TITLE_EDIT','Edit posada type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE','posada type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC','posada type description');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_SAVED','posada type saved');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete posada type. posada type is assigned to one or more properties, please re-assign them before trying to delete');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_DELETED','posada type(s) deleted');

/**
* @ignore
*/
define('_JOMRES_FRONT_posada_BOOKINGCHECK_NOROOMS','<font color=red>Error, posada has no rooms.</font>');
/**
* @ignore
*/
define('_JOMRES_FRONT_posada_BOOKINGCHECK_NOTARIFFS','<font color=red>Error, posada has no tariffs.</font>');
/**
* @ignore
*/
define('_JOMRES_FRONT_posada_BOOKINGCHECK_NOROOMTYPES','<font color=red>Error, posada has no room/posada types.</font>');

/**
* @ignore
*/
define('_JOMRES_FRONT_posada_SWAP','Change posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_GALLERYLINK','View photos of this posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GALLERYLINK_DESC','Put a link to your photo album for this posada here. It will show on the posada description page, when filled.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD','Batch posada image upload');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE_DESC','Set this to yes if you want to show the slideshow inline with the posada details.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','<br />Sorry, no images available for this posada. Please upload some images using the batch upload feature if you wish to use the slideshow feature.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Use this form to upload multiple images of this posada.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload room specific images or the posada header image, you will need to upload them from the posada Admin section.<br/><b>Note</b> Images uploaded here will be written to the /images/stories/jomres/*posada_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES','Use global posada features');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES_DESC','Set this to Yes if you want to force all properties to use only the posada features defined by the webmaster.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES_INFO','To assign an image to this feature you first need to upload your posada feature images to the /images/stories/jomres/pfeatures/ folder. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKTHISposada','Book now');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE','Show detailed posada info below this link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_posadaLISTDESC','Description limit');
/**
* @ignore
*/
define('_JOMRES_COM_posadaLISTDESC_DESC',"This limits the number of characters shown in the posada listing when drawing from the posada description.");
...
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES','Use global room/posada types');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all properties to use only the room/posada types defined by the webmaster. You need to set this to Yes if you intend to allow searching via room/posada types.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_INFO','To assign an image to this room/posada type you first need to upload your room/posada type images to the /images/stories/jomres/rmtypes/ folder. ');
...
* @ignore
*/
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Please provide the country and region of your posada.');
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1','Please complete your posada details.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_REGISTRATION_AUDIT_CREATEposada','Created posada');
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_NOTALLOWED',"Sorry, you can't create a posada on this system. You must be a logged in, registered user before you can proceed.");
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_CREATEDposada','Created posada: ');
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_CREATEDposada_FORUSER','For user: ');
...
* @ignore
*/
define('_JOMRES_BACKTOposadaDETAILSLINK','Back to posada details');
/**
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Room/posada types');
...
* @ignore
*/
define('_JOMRES_METADATA_USEYESNO_DESC','If you set this to Yes, then Jomres will use text that is repeated from posada description & posada Listings pages to generate Metadata. Seperate words with a space.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP','Look here to see if the posada is available at this time.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMINposadaDETAILS','Show availability calendar in posada details page?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to availability calendar in posada details page?');
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the posada header and details, so that only the rooms list/availability calendar is viewable in the posada details section. Only really intended for users renting out single room properties (eg apartments, cottages etc).');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Booking form overlib show room/posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SINGLEROOMposada_ERROR','You have configured Jomres as a single room posada (eg an apartment, cottage, villa) however you have more than one room created. This may result in errors when using Jomres, so if you are going to continue using Jomres to manage a single room posada you need to remove all but one of the rooms. Please modify your configuration so that Single Room posada = No, then go to posada Admin and remove all rooms except one, so that you only have one room against this posada.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_USERIS_SUPERposadaMANAGER','Super posada Manager');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_EDITposada_SELECTCOUNTRY','Select your country before adding any posada information');
/**
* @ignore
*/
define('_JOMRES_EDITposada_SAVEBEFOREUPLOAD','Save your posada changes before uploading a posada image');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_PTYPES','List all properties by posada type.');
/**
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','List all properties by room/posada type.');
...
* @ignore
*/
define('_JOMRES_SORTORDER_posadaNAME','posada Name');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_posadaREGION','posada Region');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_posadaTOWN','posada Town');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_PATHWAY_posadaLIST','posada list');
/**
* @ignore
*/
define('_JOMRES_PATHWAY_posadaDETAILS','posada details - ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_CALENDARNOTE','Note! These options only affect the language format in modules. To adjust the javascript langauge format for a given posada please edit that javascript calendar options within that posada');
/**
* @ignore
*/
...
Micromanage: You can modify the price for each and every day for each room/posada type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference rooms and tariffs to room/posada types and allows you to configure rooms and prices on the same page.<br/>
...
* @ignore
*/
define('_JOMRES_COM_A_LISTROOMSINposadaDETAILS','Show rooms list in posada details page?');
/**
* @ignore
*/
define('JOMRES_posadaTYPE','posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_MYUSER_posadaTYPE','posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_ROOMTYPE','Room/posada type ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your posada Details page.');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_MAXPEOPLEINposada','Max people that posada can accommodate');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_LASTMINUTE_posadaLIST_PRE',' ');
/**
* @ignore
*/
define('_JOMCOMP_LASTMINUTE_posadaLIST_MID','% discount if you book to arrive before ');
/**
* @ignore
*/
define('_JOMCOMP_LASTMINUTE_posadaLIST_POST','. Book now to make the most of this offer!');
/**
* @ignore
*/
define('_JOMCOMP_LASTMINUTE_posadaDETAILS_PRE',' ');
/**
* @ignore
*/
define('_JOMCOMP_LASTMINUTE_posadaDETAILS_MID','percent discount if you book to arrive before ');
/**
* @ignore
*/
define('_JOMCOMP_LASTMINUTE_posadaDETAILS_POST','.');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed tariff information in the posada details/tariff popup');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MINIMALCONFIG_DESC','Set this to Yes to reduce the number of options available to posada managers in the General Configuration section. This is useful if you do not want posada managers to play around with too many settings, instead you can edit jomres_config.php to define default posada options.');
/**
* @ignore
*/
define('_JOMCOMP_AMEND','Amend Booking - posada Selection');
/**
* @ignore
*/
define('_JOMCOMP_AMEND_SELECTposada','Select New posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC','Choose the default commission rate that will be applied to a posada in the event that another commission rate is not otherwise set.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_posadaNAME','posada name');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_posadaADDRESS','posada address');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_VIEWposada','posada view');
...
* @ignore
*/
define('_JRPORTAL_LISTBOOKINGS_HEADER_posada_ID','posada id');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CPANEL_ADDposada','Add posada');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADDposada_ISSRP','Is this a multiroom posada?');
/**
* @ignore
*/
define('_JRPORTAL_ADDposada_ISSRP_DESC','Is this a posada like a hotel/bed and breakfast/penzion? If so, select Yes. If it is a single room posada like a villa/cottage then choose No.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEposada','Associated posada (if applicable)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have posada type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this posada type so rooms become, for example, DVDs, etc.');
/**
* @ignore
*/
define('_JOMRES_EDITposada_CONNOTDELETE1','You cannot delete this posada as it is the only posada that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ');
/**
* @ignore
*/
define('_JOMRES_EDITposada_CONNOTDELETE2','If this is a demo installation and you intend to upgrade to Jomres Solo (one posada only limit) then you should create a new posada first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ');
...
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP',"Is this posada a hotel/bed and breakfast/guest house/pension? ");
/**
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out rooms in a posada, or the posada itself. Select Yes if you are offering rooms, select No if you are offering the entire posada. ");
...
* @ignore
*/
define('_JOMRES_SLIDESHOW_LOCATION',"Show slideshow above posada details or below.");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','posada enquiry from ');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS','Thank you for your enquiry, your message has been sent to the posada\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWposada','View posada task alias');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWposada_DESC','');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_COUNTRY','Add country to url');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_COUNTRY_DESC','');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_REGION','Add region to url');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_REGION_DESC','');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_TOWN','Add town to url');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_TOWN_DESC','');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_PTYPE','Add posada type to url');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_PTYPE_DESC','');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_posadaNAME','Add posada name to url');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_posadaNAME_DESC','');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_posada_ID','Append posada id to posada name');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_posada_URL_posada_ID_DESC','if posada name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE','Search URL Structure - posada type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_PTYPE','Search URL Structure - Default posada type');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC','Used in url if search is for all posada types');
/**
* @ignore
*/

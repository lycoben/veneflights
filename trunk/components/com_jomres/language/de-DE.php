...
* @ignore
*/
define('_JOMRES_COM_MR_NEWPROPERTY','Neues Unterkunft');/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SMOKING_OPTION_DESC','Achtung: Wenn Sie hier JA als Voreinstellung wählen, aber all Ihre Zimmer Nichtraucherzimmer sind, werden keine Zimmer in der Buchungsübersicht angezeigt!');/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Dieses Unterkunft buchen');/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CONFIG_DEFAULT_CRATE','Default Provision Raten');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CPANEL_LISTCRATES','Provision Raten Liste');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_LISTBOOKINGS_HEADER_CONTRACT_ID','Vertrags Identification');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP',"Ist diese Unterkunt einen Hotel/Pension oder /Hause/Ferienwohnung? ");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_CONFIRMATION_HEADER',"Eine Zusammenfassung Ihrer Buchung sehen Sie untenhalb.<br /> Um Änderungen vorzunehmen, klicken Sie bitte auf den Button Reservierung ändern. ");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SITELANGUAGE_FILE',"Default Sprachdatei");
/**
* @ignore
*/

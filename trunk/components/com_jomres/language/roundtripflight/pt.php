...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Asiento');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS','Desculpe, mas năo dispomos de asiento para o número total de Hóspedes');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','ATENÇĂO: Nem todos os asiento atendem a sua solicitaçăo. Por Favor verifique novamente');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Reserva feita para linea de vuelos: ');

/**
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Reserva feita para vuelo: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED','Asiento ocupados');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','No allowance can be made for meals not taken or for asiento not occupied for o full poriod do o boking. With thé in mind nós strongly recommfim that vocę use a holiday insurance facility.'); //#############Check the laws
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKING','Reservas de Asiento');
...
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','Exemplo: Se vocę está arrendando todo o seu estabelecimento, ao  invés de SOMENTE os asiento, neste caso entăo, vocę deve certificar-se de ter disponibilizado APENAS UM QUARTO para este estabelecimento.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MESSAGES_REVIEWCHOSENROOM','Revisar a escolha dos asiento');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED','Alguns asiento marcados já estăo reservados. Se vocę fez a Reserva admin dos UH vocę precisa cancelar as reservas primeiro.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Por favor escolha as UH que vocę deseja retirar do serviço, e as datas referentes. <br>If a habitacion does not have a check mark against it, it cannot be included in the black booking until any outstanding bookings have been completed/cancelled.<br/> When you have selected the appropriate dates, click the blue "apply" button to re-check habitacion availability. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Book a habitacion');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Reserva !');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SHOWDETAILEDROOMINFO','Show detailed habitacion information?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Tipo de Voo');
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Selecione os asiento de que necessita');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Asiento disponíveis');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selecionado asiento');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION','Click now to add this habitacion to your selection');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE','Click now to remove this habitacion from your selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','The figure calculated is a percentage of the Base figure calculated for the habitacion. If this is set to no then the figure you specify is simply added or subtracted from the base habitacion value.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_POSNEG_TT','The figure calculated is added to or removed from the Base figure calculated for the habitacion. Set this to No if you want this to be a discount from the base figure. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the property header and details, so that only the rooms list/availability calendar is viewable in the property details section. Only really intended for users renting out single habitacion properties (eg apartments, cottages etc).');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Booking form habitacion list show habitacion number');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Booking form habitacion list show habitacion name');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Booking form habitacion list show tariff title');
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NUMBER','Booking form overlib show habitacion number');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NAME','Booking form overlib show habitacion name');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Booking form overlib show habitacion type');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_SMOKING','Booking form overlib show habitacion smoking');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_ACCESS','Booking form overlib show habitacion disabled access');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FLOOR','Booking form overlib show habitacion floor');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_MAXPEEPS','Booking form overlib show habitacion maximum people');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FEATURES','Booking form overlib show habitacion features');
...
* @ignore
*/
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','You have configured Jomres as a single habitacion property (eg an apartment, cottage, villa) however you have more than one habitacion created. This may result in errors when using Jomres, so if you are going to continue using Jomres to manage a single habitacion property you need to remove all but one of the rooms. Please modify your configuration so that Single Room Property = No, then go to Property Admin and remove all rooms except one, so that you only have one habitacion against this property.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Escolha');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','Não asiento seleccionados ainda');
...
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','Listar todas as companhias aereas por tipo.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYLIST','Lista de companhia aerea');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY','Re-checking habitacion availability<br/>(Room selection will be reset)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION','Changing your habitacion selection');
/**
* @ignore
*/
...
Normal mode: You will have one tariff for each habitacion type that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each habitacion/property type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference rooms and tariffs to habitacion/property types and allows you to configure rooms and prices on the same page.<br/>
...
Advanced mode lets you create a habitacion and associate it with a habitacion type. You then create a tariff and associate THAT with a habitacion type. Using this method it is possible to \"layer\" tariffs over each other, for example a habitacion type \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a habitacion or tariff from a habitacion/property type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
...
* @ignore
*/
define('JOMRES_MAXPEOPLEINROOM','Max people per habitacion');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_TITLE_DESC','This plugin allows you to enable and configure your habitacion prices dynamically.');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_TITLE_DESC_FULL','Most businesses will recalculate habitacion prices based on the number of rooms of a required type that are available on a given date. This allows them to offer discounts on a habitacion type that isn\'t busy during a given period with the aim of attracting business that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of rooms of a selected type are available in the property on a given day.<br/> The days threashold defines the number of days that the arrival date must be within before habitacion prices are adjusted by this feature, then the percentages options allow you to configure the percentage of rooms that can be available before a given discount is applied.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP_DESC','Is this a property like a hotel/bed and breakfast/penzion? If so, select Yes. If it is a single habitacion property like a villa/cottage then choose No.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Ida e volta vuelo Total");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"Puntos de vuelo");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per pessoa por sede ");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERPERSON',"por pessoa por voo ");
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of rooms already selected in booking before tariff/habitacion type combo can be offered. Allows you to have discounted tariffs when more than N rooms are already selected. ');
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of rooms already selected in booking before tariff/habitacion combo is no longer offered. Allows you to stop offering this habitacion type/tariff combination once N rooms have been selected in the booking form. ');
/**
* @ignore
*/

...
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM','Per Volo:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"Al volo(s) a");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per volo");
/**
* @ignore
*/

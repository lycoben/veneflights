...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMSCONFIGDESC','Tours/Operator Configuration');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYCONFIGDESC','Operator Configuration');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOM','New tour');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMFEATURE','New tour feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMCLASS','New tour/property type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VIEWBOOKINGS_DEPARTURE','NOTE! Departure is the same as arival date!');
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN','Operator manager');
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Room/Operator type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_TITLE','Quick Res select tour/property types');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_DAYSDATE_DESC','Enter EITHER the tours the guest will be staying, or the departure date');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_NUMBEROFDAYS','Number of tours');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the tour/property type required, the arrival date of the guest and either the number of tours the guest is staying or their departure date. Finally, enter the number of adults & children in the contingent.');

/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Our tours');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Operator');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS','Sorry, but our available tours cannot service this many guests');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ERROR_NOROOMTYPESSELECTED','<font color="red" face="arial" size="4">ERROR: You did not select any tour/property types.<br>Press the back button & re-enter your data.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View tours & property config');

/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOM','Tours');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYS','Operator');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_PROPERTY','Operator');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_CLICKTOEDIT','Click the tour uid link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_CLICKTOEDIT','Click the tour features link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_CLICKTOEDIT','Click the tour class uid link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_LINK','Operator');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT','Operator added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE','Operator updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK','Operator Features');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV','Operator feature abbv.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC','Operator feature full description');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT','Operator feature added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE','Operator feature updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_LISTTARIFF_ROOMRATEPERDAY','Rate per tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_PUBLICHOLIDAY_TITLE_HELP','The end date of the public holiday period should be the last tour that you intend to bill the guests at public holiday rates.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAROOM','Book a tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Operator admin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the tour/property type required, your arrival date and the number of tours you will be staying. Finally, enter the number of adults & children in the contingent.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_INSTRUCTIONS2','Please select the tour that you require.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_SUBMITBUTTON_CHOOSEROOM','I want this tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_TITLE','Select tour/property types');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','There are no tours available able to satisfy the parameters specified');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Booking made for Tour provider: ');

/**
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Booking made for tour: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_TEXT_NUMBEROFNIGHTS','Days staying: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_WELCOME_STRANGER','Welcome stranger. Before you can book a tour, you need to update your details under the "My Details" link.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED','Tours occupied');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_NAVIGATETODATE','View tour usage from:');
...
* @ignore
*/
define('_JOMRES_COM_A_DISCOUNTS_AVAILABLE_DESC','The discount scheme is for those who wish to offer people discounts depending on the number of guests in a party. Because it operates on the numbers in a party, it is not recommended that you use it if you do not charge on a per-person-per-tour basis.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_TARIFFS_PER','Per person, per tour');
/**
* @ignore
*/
define('_JOMRES_COM_A_TARIFFS_PER_DESC','Select Yes if you want to charge per-person-per-tour. If no, then costs will be calculated on a per-tour-per-tour basis');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKFORWEEKROOMSUSAGE','Click for week tour usage starting today');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKONROOMFORBOOKINGINFO','Click on a booked tour to view the booking');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_TAPEVIEWKEY','<br>Tours with a blue background are booked, however<br> if a tour has red text, then no deposit has been paid.<br> Where a tour has a star against "Booked" then the guest is expected to arrive on this day.<br> If a tour has yellow text, then the guest is currently occupying the tour.');
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RATE_RULES','Cost per tour - per tour ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Your tour will be held until your arrival, and check in is after 2pm.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','No allowance can be made for meals not taken or for tours not occupied for the full period of the booking. With this in mind we strongly recommend that you use a holiday insurance facility.');
/**
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_CANCELLATIONCHARGES_INTRO','<i>Cancellation and curtailment charges</i> If you cancel your holiday the cancellation must be confirmed in writing. Chancellation charges are as follows:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_RATE_RULES','Cost per tour - per tour ');
/**
* @ignore
*/
define('_JOMRES_COM_INVOICE_STAYNIGHTS','Number of tours: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_COSTPERNIGHT','Cost per tour: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_CHOOSEPROPERTY','Choose the property you want tour availability information on');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_PROPERTY','Operator');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE','Unable to remove this tour, there are bookings against it. Cancel those bookings then retry.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_DELETE','Delete tour feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this tour feature, it is assigned to some tours. Remove the feature from those tours and retry.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETED','Operator feature deleted');

/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete tour/property type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this tour/property type, it is assigned to a tour. Try re-assigning the tour to another tour/property type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this tour/property type, it is assigned to a tariff. Try re-assigning the tariff to another tour/property type then try again.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTY_DELETED','Operator deleted');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_DESC','Which property will your tour be associated with?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Operator description');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Set this to Yes to ensure that visitors can book tours online.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKING','Booking tours');
...
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a property, rather than tours in that property. If this is the case, then you must make sure that you only have the one tour registered against each property.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when property/tour is available');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cell bgcolour for provisionally booked tours (bookings for which a deposit has not been taken)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MESSAGES_REVIEWCHOSENROOM','Review your chosen tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_BOOKTHESEROOMS','Black book these tours');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_ACTUALROOMCOST','Actual tour cost: ');
...
* @ignore
*/
define('_JOMRES_COM_A_PAYPAL_EMAIL_DESC','Note: To use paypal you must goto your paypal account & enable Autoreturn. (Profile/Website Payment Preferences) Set Auto Return: On, Set Return URL: http://www.domain.com/index.php?option=com_jomres&task=bookatour&action=success  ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_LISTING_PROPERTY','Operator rights');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM','Created tour');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM','Updated tour');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM','Deleted tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Booked a tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED','One or more of the tours checked are already booked. If you wish to Black Book these tours you first need to cancel the bookings against them.');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','There was an error attempting to book these tours, one or more of the tours you selected is not free.');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Tours included in black booking');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES','Show tour names?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES_DESC','Set this to Yes to show tour names?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES','Show tour/property types?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES_DESC','Set this to Yes to show tour/property types?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SMOKING_OPTION_DESC','Be aware: If your default option is Yes and all your tours are No smoking, then no tours will show up in the bookings page listing.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_ROOMTAX_DESC','Designed for the American market. These are the tour tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the tour.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_PPPN','Per person per day tour');
/**
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_PN','Per tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PTYPE','Operator type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE','Operator type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC','Operator type description');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_SAVED','Operator type saved');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete property type. Operator type is assigned to one or more properties, please re-assign them before trying to delete');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_DELETED','Operator type(s) deleted');

/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMS','<font color=red>Error, property has no tours.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMTYPES','<font color=red>Error, property has no tour/property types.</font>');
...
* @ignore
*/
define('_JOMRES_COM_MONTHSTOSHOW_DESC','In the tour availability, How many months of the calendar should be shown?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Please choose the tour(s) you wish to take out of service, and the relevant dates. <br>If a tour does not have a check mark against it, it cannot be included in the black booking until any outstanding bookings have been completed/cancelled.<br/> When you have selected the appropriate dates, click the blue "apply" button to re-check tour availability. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Use this form to upload multiple images of this property.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload tour specific images or the property header image, you will need to upload them from the Operator Admin section.<br/><b>Note</b> Images uploaded here will be written to the /images/stories/jomres/*property_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Book a Tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS','Leaving From Caracas to:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click for Tours and availability');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show tours and availability below this link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES','Use global tour/property types');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all properties to use only the tour/property types defined by the webmaster. You need to set this to Yes if you intend to allow searching via tour/property types.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_INFO','To assign an image to this tour/property type you first need to upload your tour/property type images to the /images/stories/jomres/rmtypes/ folder. ');
...
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Number of tours available');
/**
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE_INFO','Please select the number of tours you require, of the type you require.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Tour/Operator types');
...
* @ignore
*/
define('_JOMRES_METADATA_USEYESNO_DESC','If you set this to Yes, then Jomres will use text that is repeated from property description & Operator Listings pages to generate Metadata. Seperate words with a space.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Select the tours that you require');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PERDAY','Per tour');
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Available tours');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selected tours');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM','Per tour:');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM_TOTAL','Tour(s)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar/Tours list?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the property header and details, so that only the tours list/availability calendar is viewable in the property details section. Only really intended for users renting out single tour properties (eg apartments, cottages etc).');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Booking form overlib show tour/property type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','You have configured Jomres as a single tour property (eg an apartment, cottage, villa) however you have more than one tour created. This may result in errors when using Jomres, so if you are going to continue using Jomres to manage a single tour property you need to remove all but one of the tours. Please modify your configuration so that Single Room Operator = No, then go to Operator Admin and remove all tours except one, so that you only have one tour against this property.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_MESSAGES_TODO_','Per tour:');
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','You have chosen more tours than you have guests, click on a tour name to remove it from your selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','You need to choose more tours');
/**
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Select a tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SRP_WEHAVEVACANCIES','We have a Full Day Tour to Los Roques available for you and your party!');
/**
* @ignore
*/
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No tours selected yet');
...
* @ignore
*/
define('_JOMRES_COM_LIMITROOMSLIST','Available tours/tariff limit');
/**
* @ignore
*/
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available tours & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Super Operator Manager');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the tours list.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','List all properties by tour/property type.');
...
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYNAME','Operator Name');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYREGION','Operator Region');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYTOWN','Operator Town');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYLIST','List of Day tours to Los Roques');
/**
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Operator details - ');
/**
* @ignore
*/
...
Micromanage: You can modify the price for each and every day for each tour/property type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference tours and tariffs to tour/property types and allows you to configure tours and prices on the same page.<br/>
...
Advanced mode lets you create a tour and associate it with a tour type. You then create a tariff and associate THAT with a tour type. Using this method it is possible to \"layer\" tariffs over each other, for example a tour type \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a tour or tariff from a tour/property type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of tours and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
* @ignore
*/
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show tours list in property details page?');
/**
* @ignore
*/
define('JOMRES_PROPERTYTYPE','Operator type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_MYUSER_PROPERTYTYPE','Operator type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_TITLE_DESC_FULL','Most businesses will recalculate tour prices based on the number of tours of a required type that are available on a given date. This allows them to offer discounts on a tour/property type that isn\'t busy during a given period with the aim of attracting business that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of tours of a selected type are available in the property on a given day.<br/> The days threshold defines the number of days that the arrival date must be within before tour prices are adjusted by this feature, then the percentages options allow you to configure the percentage of tours that can be available before a given discount is applied. Note however, if multiple tours are booked then the current level of discount will be applied to all tours and will not reduce as more tours are selected.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE10','Percentage tours occupied 10% or less');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE25','Percentage tours occupied 25% or less');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE50','Percentage tours occupied 50% or less');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE75','Percentage tours occupied 75% or less');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_ROOMTYPE','Room/Operator type ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Operator Details page.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_AMEND','Amend Booking - Operator Selection');
/**
* @ignore
*/
define('_JOMCOMP_AMEND_SELECTPROPERTY','Select New Operator');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Operator name');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Operator address');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_VIEWPROPERTY','Operator view');
...
* @ignore
*/
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Operator id');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP','Is this a multitour property?');
/**
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP_DESC','Is this a property like a hotel/bed and breakfast/penzion? If so, select Yes. If it is a single tour property like a villa/cottage then choose No.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have property type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this property type so tours become, for example, DVDs, etc.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out tours in a property, or the property itself. Select Yes if you are offering tours, select No if you are offering the entire property. ");
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Tour(s) Total");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"tour(s) at");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERPERSON',"per person per tour ");
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','Enquiry from ');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS','Thank you for your enquiry, your message has been sent to the posada - yacht owner - turist service provider\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Please select your required service - from the list on the right');

/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min Day tours already selected');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of Day tours already selected in booking before tariff/tour type combo can be offered. Allows you to have discounted tariffs when more than N Day tours are already selected. ');

/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max Day tours already selected');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of Day tours already selected in booking before tariff/tour combo is no longer offered. Allows you to stop offering this tour type/tariff combination once N Tours have been selected in the booking form. ');
/**
* @ignore
*/

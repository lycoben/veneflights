...
class j16000list_usersinvoices
	...
	function j16000list_usersinvoices()
		...
		if ($id>0)
			...
			$output['TASK_FILTER_ANY']='<a href="index2.php?option=com_jomres&task=list_usersinvoices&id='.$id.'">'._JOMRES_FRONT_ROOMSMOKING_EITHER.'</a>';
			$output['TASK_FILTER_UNPAID']='<a href="index2.php?option=com_jomres&task=list_usersinvoices&id='.$id.'&status=unpaid">'._JRPORTAL_INVOICES_STATUS_UNPAID.'</a>';
			$output['TASK_FILTER_PAID']='<a href="index2.php?option=com_jomres&task=list_usersinvoices&id='.$id.'&status=paid">'._JRPORTAL_INVOICES_STATUS_PAID.'</a>';
			$output['TASK_FILTER_CANCELLED']='<a href="index2.php?option=com_jomres&task=list_usersinvoices&id='.$id.'&status=cancelled">'._JRPORTAL_INVOICES_STATUS_CANCELLED.'</a>';
			$output['TASK_FILTER_PENDING']='<a href="index2.php?option=com_jomres&task=list_usersinvoices&id='.$id.'&status=pending">'._JRPORTAL_INVOICES_STATUS_PENDING.'</a>';
			...
			$jrtb .= $jrtbar->toolbarItem('new',jomresURL("index2.php?option=com_jomres&task=edit_invoice"),'');

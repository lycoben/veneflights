...
class j16000save_invoice {
	function j16000save_invoice()
		...
		if ($original_status != 1 && $status == 1)
			...
			jomresRedirect( jomresURL("index2.php?option=com_jomres&task=list_invoices&status=paid"), "" );
			}
		
		jomresRedirect( jomresURL("index2.php?option=com_jomres&task=list_invoices"), "" );
		}

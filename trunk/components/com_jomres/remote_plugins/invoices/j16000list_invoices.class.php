...
class j16000list_invoices
	...
	function j16000list_invoices()
		...
		$output['HCURRENCYCODE']=_JRPORTAL_INVOICES_CURRENCYCODE;
			...
			$output['TASK_FILTER_ANY']='<a href="index2.php?option=com_jomres&task=list_invoices">'._JOMRES_FRONT_ROOMSMOKING_EITHER.'</a>';
			$output['TASK_FILTER_UNPAID']='<a href="index2.php?option=com_jomres&task=list_invoices&status=unpaid">'._JRPORTAL_INVOICES_STATUS_UNPAID.'</a>';
			$output['TASK_FILTER_PAID']='<a href="index2.php?option=com_jomres&task=list_invoices&status=paid">'._JRPORTAL_INVOICES_STATUS_PAID.'</a>';
			$output['TASK_FILTER_CANCELLED']='<a href="index2.php?option=com_jomres&task=list_invoices&status=cancelled">'._JRPORTAL_INVOICES_STATUS_CANCELLED.'</a>';
			$output['TASK_FILTER_PENDING']='<a href="index2.php?option=com_jomres&task=list_invoices&status=pending">'._JRPORTAL_INVOICES_STATUS_PENDING.'</a>';

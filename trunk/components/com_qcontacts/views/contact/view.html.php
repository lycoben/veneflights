...
class QContactsViewContact extends JView {
	function display($tpl = null)
	{
		...
		switch ($cparams->get('contact_icons'))	{
			case 1 :
				// text
			...
			default :
				...
				$image7 = JHTML::_('image.site', 'skype.png', '/administrator/components/com_qcontacts/images/', $params->get('icon_skype'), '/administrator/components/com_qcontacts/images/', JText::_('Skype').": ");
				$image8 = JHTML::_('image.site', 'yahoo.gif', '/administrator/components/com_qcontacts/images/', $params->get('icon_yahoo'), '/administrator/components/com_qcontacts/images/', JText::_('Yahoo Messenger').": ");

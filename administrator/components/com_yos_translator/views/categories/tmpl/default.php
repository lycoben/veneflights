...
//	$obj_filter = $this->filter;
	...
	JToolBarHelper::publish('list.CTpublish');
	JToolBarHelper::unpublish('list.CTunpublish');
	JToolBarHelper::customX('translatecategories.edit','translate','','Translate');
	
	JToolBarHelper::deleteList("Are you sure?",'list.removeCT');
...
<div id="tablecell">
	...
	{
		$row = &$this->rows[$i];
		$published 	= JHTML::_('grid.published', $row, $i, 'publish_g.png','publish_x.png','list.CT' );
	?>

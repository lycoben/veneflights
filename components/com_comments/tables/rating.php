...
/**
 * Comments Component Rating Table
 *
 * @package	Comments
 * @version	1.0
 */
class CommentsTableRating extends JTable
{
	...
	{
		parent::__construct('#__jxcomments_ratings', null, $db);
	}

	/**
	 * Method to load a rating record
	 *
	 * @access	public
	 ...
	 * @since	1.0
	 */
	function load( $context, $contextId, $categoryId = 0 )
	{
		$db	= &$this->getDBO();
		$db->setQuery(
			'SELECT *' .

...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMSCONFIGDESC','Seats/airline Configuration');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYCONFIGDESC','Airline Configuration');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOM','New seat');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMFEATURE','New seat feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMCLASS','New seat/airline type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWPROPERTY','New airline');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWPROPERTYFEATURE','New airline feature');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL','Default airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_CHANGEHOTEL','Change airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_LEVEL_ADMIN','Airline manager');
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_FLOOR','Level');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Seat/Airline type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Seat/airline type description');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_TITLE','Quick Res select seat/airline types');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the seat/airline type required, the arrival date of the guest and either the number of nights the guest is staying or their departure date. Finally, enter the number of adults & children in the contingent.');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMFLOOR','Level');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Airline');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Seat/airline type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS','Sorry, but our available seats cannot service this many guests');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_NOROOMSINRANGE','<font color="red" face="arial" size="3">Sorry, the airline can not offer round trip flight for this period. Please return to the calendars and review the availability displayed there.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ERROR_NOROOMTYPESSELECTED','<font color="red" face="arial" size="4">ERROR: You did not select any seat/airline types.<br>Press the back button & re-enter your data.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View Seats & airline config');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES','Se features');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES','Se types');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYS','Airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_PROPERTY','Airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_FLOOR','Level');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_UPDATE','Seat updated');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_CLICKTOEDIT','Click the Seat uid link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK','Se features');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_CLICKTOEDIT','Click the Seat features link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Seat types');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Seat/airline type abbreviation');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Seat/airline type description');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_CLICKTOEDIT','Click theSeat class uid link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Seat/airline type added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Seat/airline type updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_LINK','Airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_CLICKTOEDIT','Click the airline uid link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT','Airline added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE','Airline updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK','Airline Features');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV','Airline feature abbv.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC','Airline feature full description');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_CLICKTOEDIT','Click the airline feature uid link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT','Airline feature added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE','Airline feature updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Seat/airline type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAROOM','Book a Seat');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Airline admin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the Seat/airline type required, your arrival date and the number of nights you will be staying. Finally, enter the number of adults & children in the contingent.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_INSTRUCTIONS2','Please select the Seat that you require.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_SUBMITBUTTON_CHOOSEROOM','I want this Seat');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_TITLE','Select Seat/airline types');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Booking made for airline: ');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_WELCOME_STRANGER','Welcome stranger. Before you can book a Seat, you need to update your details under the "My Details" link.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED','Seats occupied');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_NAVIGATETODATE','View Seat usage from:');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKFORWEEKROOMSUSAGE','Click for week Seat usage starting today');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKONROOMFORBOOKINGINFO','Click on a booked Seat to view the booking');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_TAPEVIEWKEY','<br>Seats with a blue background are booked, however<br> if a Seat has red text, then no deposit has been paid.<br> Where a Seat has a star against "Booked" then the guest is expected to arrive on this day.<br> If a Seat has yellow text, then the guest is currently occupying the Seat.');
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_RATE_RULES','Cost per night - per Seat ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_OPTIN_DESC','If you choose to opt this airline into the jomres network, then it will be listed at jomres.net. Please note, it will be assumed that this is a live hotel. Paxsoft.net cannot be held responsible for your airline. You must ensure that your details are correct.');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_CHOOSEPROPERTY','Choose the airline you want Seat availability information on');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_ROOM','Seat');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_PROPERTY','Airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this Seat feature, it is assigned to some Seats. Remove the feature from those Seats and retry.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETE','Delete airline feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE','Unable to remove this airline feature, it is assigned to a airline. Remove the feature from this airline and retry.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETED','Airline feature deleted');

/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete Seat/airline type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this Seat/airline type, it is assigned to a Seat. Try re-assigning the Seat to another Seat/airline type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this Seat/airline type, it is assigned to a tariff. Try re-assigning the tariff to another Seat/airline type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Seat/airline type deleted');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTY_DELETE','Delete airline');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTY_UNABLETODELETE_MESSAGE','Unable to remove this airline, it has data in table: ');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTY_DELETED','Airline deleted');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS','You do not have rights to delete this airline.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_BUTTON','Choose this airline');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_DESC','Which airline will your Seat be associated with?');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_SELECTPROPERTY','Select a airline');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_MUSTSELECTPROPERTY','You must select a airline');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Airline description');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPERTYKEY','Your Paxsoft.net airline key');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPERTYKEY_DESC','When you are ready to put your website up on the web, visit <a href="http://www.jomres.net" target="_blank">Paxsoft.net</a> for your airline key. With that jomres can register your airline on the Paxsoft Network, ensuring that your reach the widest possible audience for your business.');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_OURPROPERTIES','Our airlines');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_THISPROPERTYADDRESS','The plane leaves from:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a airline, rather than Seats in that airline. If this is the case, then you must make sure that you only have the one Seat registered against each airline.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when airline/seat is available');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MESSAGES_REVIEWCHOSENROOM','Review your chosen Seat');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_BOOKTHESEROOMS','Black book these Seats');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CALENDAROUTPUT_DESC','This allows the user to change the output format of dates within Paxsoft');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CALENDARINPUT_DESC','This allows the user to change the input format of dates within Paxsoft.');
...
* @ignore
*/
define('_JOMRES_COM_A_PAYPAL_EMAIL_DESC','Note: To use paypal you must goto your paypal account & enable Autoreturn. (Profile/Website Payment Preferences) Set Auto Return: On, Set Return URL: http://www.domain.com/index.php?option=com_jomres&task=bookaseat&action=success  ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_LISTING_PROPERTY','Airline rights');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Created se feature');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Updated se feature');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Deleted se feature');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Inserted se type');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Updated se type');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Deleted se type');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY','Created airline');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY','Updated airline');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY','Deleted airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM_IMAGE','Uploaded new se image');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_IMAGE','Uploaded diff se image');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BUTTON','Select this airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED','One or more of the Seats checked are already booked. If you wish to Black Book these Seats you first need to cancel the bookings against them.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES','Show Seat names?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES_DESC','Set this to Yes to show Seat names?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES','Show Flight/airline types?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES_DESC','Set this to Yes to show Flight/airline types?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SMOKING_OPTION_DESC','Be aware: If your default option is Yes and all your Seats are No smoking, then no Seats will show up in the bookings page listing.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GODMANAGERWARNING','<font color=red>Warning...You are logged in as a manager with privileges for all airlines. Be aware that this may cause problems when performing some functions within Paxsoft.</FONT>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Flight/airline type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_PPPN','Per person per flight');
/**
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_PN','Per flight');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PTYPE','Airline type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_LIST_TITLE','List airline types');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_LIST_TITLE_EDIT','Edit airline type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE','Airline type');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC','Airline type description');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_SAVED','Airline type saved');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete airline type. Airline type is assigned to one or more airlines, please re-assign them before trying to delete');
/**
* @ignore
*/
define('_JOMRES_COM_PTYPES_DELETED','Airline type(s) deleted');

/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMS','<font color=red>Error, airline has no Seats.</font>');
/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOTARIFFS','<font color=red>Error, airline has no tariffs.</font>');
/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMTYPES','<font color=red>Error, airline has no Seat/airline types.</font>');

/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_SWAP','Change airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Please choose the Seat(s) you wish to take out of service, and the relevant dates. <br>If a Seat does not have a check mark against it, it cannot be included in the black booking until any outstanding bookings have been completed/cancelled.<br/> When you have selected the appropriate dates, click the blue "apply" button to re-check Seat availability. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_GALLERYLINK','View photos of this airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GALLERYLINK_DESC','Put a link to your photo album for this airline here. It will show on the airline description page, when filled.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_JR_A_IMAGEHANDLING_BATCHUPLOAD','Batch airline image upload');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE_DESC','Set this to yes if you want to show the slideshow inline with the airline details.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','<br />Sorry, no images available for this airline. Please upload some images using the batch upload feature if you wish to use the slideshow feature.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Use this form to upload multiple images of this airline.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload Seat specific images or the airline header image, you will need to upload them from the Airline Admin section.<br/><b>Note</b> Images uploaded here will be written to the /images/stories/jomres/*airline_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES','Use global airline features');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES_DESC','Set this to Yes if you want to force all airlines to use only the airline features defined by the webmaster.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES_INFO','To assign an image to this feature you first need to upload your airline feature images to the /images/stories/jomres/pfeatures/ folder. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS','The plane leaves from:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE','Show detailed airline info below this link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_TARIFFS_MODEL_DESC',"You have two choices of tariff calculation methods. The first, the 'flat rate' method allows you to offer a number of different tariffs to the guest and the rate for the stay is the same for the entire time. This is useful if you want to offer several different tariffs for the same date, eg Bed and Breakfast tariff and B&B and Evening meal tariff. Choose the 'averages' tariff if you want to adjust your prices dependant on the date in question. Paxsoft will find all of the tariffs for each day in the booking, add them together then return the average rate across the period");

/**
* @ignore
*/
define('_JOMRES_COM_A_PORTAL','Use Paxsoft portal?');
/**
* @ignore
*/
define('_JOMRES_COM_A_PORTAL_DESC','Set this to Yes if Paxsoft is going to be used in conjunction with the Paxsoft portal software');
...
* @ignore
*/
define('_JOMRES_COM_PROPERTYLISTDESC_DESC',"This limits the number of characters shown in the airline listing when drawing from the airline description.");
...
* @ignore
*/
define('_JOMRES_COM_A_DAILYRATEMULTIPLIER_DESC',"This allows the user to append a multiplier to the daily rate that is returned to booking form during the booking process (useful if you want to show a airlines rate by the week for example)");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES','Use global Seat/airline types');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all airlines to use only the Seat/airline types defined by the webmaster. You need to set this to Yes if you intend to allow searching via Seats/airline types.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_INFO','To assign an image to this Seat/airline type you first need to upload your Seat/airline type images to the /images/stories/jomres/rmtypes/ folder. ');
...
* @ignore
*/
define('_JOMRES_COM_USESITEHELP_DESC','Set this to Yes if you want Paxsoft to show the site help text above the search bar.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SELFREGISTRATION','Users can register their airlines?');
/**
* @ignore
*/
define('_JOMRES_COM_SELFREGISTRATION_DESC','Set this to Yes if you want users to be able to register their own airlines without admin intervention.');

/**
* @ignore
*/
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','Please provide the country and region of your airline.');
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1','Please complete your airline details.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY','Created airline');
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_NOTALLOWED',"Sorry, you can't create a airline on this system. You must be a logged in, registered user before you can proceed.");
/**
* @ignore
*/
define('_JOMRES_REGISTRATION_CREATEDPROPERTY','Created airline: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SHOWDETAILEDROOMINFO','Show detailed Seat information?');
/**
* @ignore
*/
define('_JOMRES_SHOWDETAILEDROOMINFO_DESC','If you set this to No, then Paxsoft will not attempt to show all the during bookings, instead it will simply advise that availability exists.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE_INFO','Please select the number of Seats you require, of the type you require.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BACKTOPROPERTYDETAILSLINK','Back to airline details');
/**
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Flight/Airline types');

/**
* @ignore
*/
define('_JOMRES_METADATA_USEYESNO','Use Paxsoft metadata?');
/**
* @ignore
*/
define('_JOMRES_METADATA_USEYESNO_DESC','If you set this to Yes, then Paxsoft will use text that is repeated from airline description & Airline Listings pages to generate Metadata. Seperate words with a space.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP','Look here to see if the airline is available at this time.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM','Per flight:');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM_TOTAL','Round trip flight');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION','Click now to add this Seat to your selection');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE','Click now to remove this Seat from your selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMINPROPERTYDETAILS','Show availability calendar in airline details page?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to availability calendar in airline details page?');

/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar/Seats list?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the airline header and details, so that only the Seats list/availability calendar is viewable in the airline details section. Only really intended for users renting out single Seat airlines (eg apartments, cottages etc).');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NUMBER','Booking form overlib show Seat number');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NAME','Booking form overlib show Seat name');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Booking form overlib show Seat/airline type');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_SMOKING','Booking form overlib show Seat smoking');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_ACCESS','Booking form overlib show Seat disabled access');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FLOOR','Booking form overlib show Seat level');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_MAXPEEPS','Booking form overlib show Seat maximum people');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FEATURES','Booking form overlib show Seat features');
...
* @ignore
*/
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','You have configured Paxsoft as a single Seat airline (eg an apartment, cottage, villa) however you have more than one Seat created. This may result in errors when using Paxsoft, so if you are going to continue using Paxsoft to manage a single Seat airline you need to remove all but one of the Seats. Please modify your configuration so that Single Seat Airline = No, then go to Airline Admin and remove all Seats except one, so that you only have one Seat against this airline.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_DASHBOARDPLUGIN_DESC','If you have installed any Paxsoft dashboard plugins you can choose an alternative to the default dashboard here.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_TOO_MANY_GUESTS_FOR_BEDS','Too many guests for the available flight');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_JRCONFIG_LINKSASICONS','Show Paxsoft admin options as icons?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_JRCONFIG_GLOBALEDITING_DESC','Take care with this function. If set to Yes, then the editing mode will affect the custom text for ALL airlines in the system for the constant you are editing.');
...
* @ignore
*/
define('_JOMRES_COM_JRCONFIG_GLOBALCURRENCYYESNO_DESC','Set this to yes to force all airlines to use the same currency (e.g. & # 8 3 6 4 ;)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Super Airline Manager');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_EDITPROPERTY_SELECTCOUNTRY','Select your country before adding any airline information');
/**
* @ignore
*/
define('_JOMRES_EDITPROPERTY_SAVEBEFOREUPLOAD','Save your airline changes before uploading a airline image');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_AVL_INFO','Please enter your intended arrival and departure dates and press the button to find airlines that have round trip flight available on your chosen dates.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','List all airlines by Seat/airline type.');
...
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYNAME','Airline Name');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYREGION','Airline Region');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYTOWN','Airline Town');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYLIST','Airlines flying to Los Roques');
/**
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Airline details - ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_CALENDARNOTE','Note! These options only affect the language format in modules. To adjust the javascript langauge format for a given airline please edit that javascript calendar options within that airline');
/**
* @ignore
*/
...
Micromanage: You can modify the price for each and every day for each Seat/airline type. <br/>
Advanced: The \"old\" Paxsoft method of managing tariffs. <br/>
<br/>
The different tariff modes allow you to choose the method of configuring tariffs that suits you best.<br/>
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference Seats and tariffs to Seat/airline types and allows you to configure Seats and prices on the same page.<br/>
...
* @ignore
*/
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show Seats list in airline details page?');
/**
* @ignore
*/
define('JOMRES_PROPERTYTYPE','Airline type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_MYUSER_PROPERTYTYPE','Airline type');
/**
* @ignore
*/
define('_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES','Airlines on site');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_ROOMTYPE','Seat/Airline type ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_NOTDISCOUNTED','Seat price not discounted ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Paxsoft will show the map in your Airline Details page.');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_MAXPEOPLEINPROPERTY','Max people that airline can accommodate');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_VERBOSETARIFFINTO_DESC','Set this to Yes to show more detailed tariff information in the airline details/tariff popup');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MINIMALCONFIG_DESC','Set this to Yes to reduce the number of options available to airline managers in the General Configuration section. This is useful if you do not want airline managers to play around with too many settings, instead you can edit jomres_config.php to define default airline options.');
/**
* @ignore
*/
define('_JOMCOMP_AMEND','Amend Booking - Airline Selection');
/**
* @ignore
*/
define('_JOMCOMP_AMEND_SELECTPROPERTY','Select New Airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CONFIG_DEFAULT_CRATE_DESC','Choose the default commission rate that will be applied to a airline in the event that another commission rate is not otherwise set.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CPANEL_LISTPROPERTIES','List Airlines');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Airline name');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Airline address');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_LEGEND','Airlines who\'s background colour is red have not yet had a commission rate applied to them.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_STATS_STATTYPE_PROPERTIES','Airlines - Clicks');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_VIEWPROPERTY','Airline view');
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_ROOMUSAGE','Seat usage');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Airline id');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CPANEL_ADDPROPERTY','Add airline');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP','Is this a multi seat airline?');
/**
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP_DESC','Is this a airline like a hotel/bed and breakfast/penzion? If so, select Yes. If it is a single Seat airline like a villa/cottage then choose No.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADD_ADHOC_ITEM_CHOOSEPROPERTY','Associated airline (if applicable)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have airline type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this airline type so Seats become, for example, DVDs, etc.');
/**
* @ignore
*/
define('_JOMRES_EDITPROPERTY_CONNOTDELETE1','You cannot delete this airline as it is the only airline that you have access to. If you want to disable it, please use the un-publish feature in your toolbar. ');
/**
* @ignore
*/
define('_JOMRES_EDITPROPERTY_CONNOTDELETE2','If this is a demo installation and you intend to upgrade to Paxsoft Solo (one airline only limit) then you should create a new airline first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ');
...
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP',"Is this airline a hotel/bed and breakfast/guest house/pension? ");
/**
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting outSeats in a airline, or the airline itself. Select Yes if you are offeringSeats, select No if you are offering the entire airline. ");
...
* @ignore
*/
define('_JOMRES_COM_JOMRESEMAILCHECK',"Use Paxsoft email address checker? ");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Round trip flight Total");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"Flight at");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SLIDESHOW_LOCATION',"Show slideshow above airline details or below.");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERPERSON',"per person per seat");
...
* @ignore
*/
define('_JOMRES_COM_A_SITELANGUAGE_FILE_DESC',"Choose the default language file that Paxsoft should use if the language hasn't been set by Joomfish.");
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Contact Us!');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','Airline enquiry from ');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_THANKS','Thank you for your enquiry, your message has been sent to the airline\'s contact email address, and copied to your own address for your records. They will respond to you as soon as possible with their reply.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Please select your required round trip flight from the list on the right');
...
* @ignore
*/
define('_JOMRES_COM_SEF_TASK_ALIAS_VIEWPROPERTY','View airline task alias');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE','Add airline type to url');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTYNAME','Add airline name to url');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID','Append airline id to airline name');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_PROPERTY_URL_PROPERTY_ID_DESC','if airline name is set to No then the id will not be used. If set to yes then the url will look like fawlty_towers-1');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_COUNTRY_DESC','If all your airlines are in one country then you will not have country in the search - enter a default country here if you want to display a country');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_REGION_DESC','If all your airlines are in one region then you will not have region in the search - enter a default region here if you want to display a region');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE','Search URL Structure - Airline type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_PTYPE','Search URL Structure - Default airline type');
/**
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_PTYPE_DESC','Used in url if search is for all airline types');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_REGISTRYREBUILD_NOTES',"Normally the Paxsoft plugin registry is rebuilt automatically whenever you view the plugin manager and add or remove a plugin, however it's possible that you cannot use these features for some reason, therefore you can use this function to rebuild the registry manually. If you have access to the Plugin Manager and Upgrades feature then it's unlikely that you will need to use this function. You will need to rebuild the plugin registry whenever you add a new mini-component and didn't use the Plugin Manager to add it.");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_REGISTRYREBUILD_FAILURE','There was an error with rebuilding the registry of minicomponents. You should check your Paxsoft error log to see if there is a record of what triggered the error.');
/**
* @ignore
*/
define('_JOMRES_SEARCH_PRICERANGES','Search by price range in USD.');
/**
* @ignore
*/

...
define('_JOMRES_COM_MR_ROOMSCONFIGDESC','Configuración de habitación/yate');
...
define('_JOMRES_COM_MR_PROPERTYCONFIGDESC','Configuración de yate');
...
define('_JOMRES_COM_MR_NEWROOM','Cabina nueva');
...
define('_JOMRES_COM_MR_NEWPROPERTY','Nueva yate');
...
define('_JOMRES_COM_MR_NEWPROPERTYFEATURE','Nueva característica de la yate');
...
define('_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL','Yate predefinida');
...
define('_JOMRES_COM_MR_ASSIGNUSER_CHANGEHOTEL','Cambiar yate');
...
define('_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM','Cabina');
...
define('_JOMRES_COM_MR_EB_GUEST_REASON_HOTELCANCELLED','Yate esta cancelado');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','cabinas');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME','Yate');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS','Lo siento, nuestras cabinaes disponibles no tienen capacidad para tantas personas');
...
define('_JOMRES_COM_MR_QUICKRES_STEP2_NOROOMSINRANGE','<font color="red" face="arial" size="3">Lo siento, La yate no puede ofrecerle alojamiento para este periodo. Por favor regrese al calendario para ver la disponibilidad.</font>');
...
define('_JOMRES_COM_MR_QUICKRES_STEP4_NOTARIFFS','Lo sentimos, no existen tarifas con los criterios especificados. Puede ser que necesitemos indagar  sus requisitos. Por favor pruebe otra vez, modificando el número de días que usted desea permanecer, o puede llamar alternativamente el yate y reservar una habitación por el teléfono.');
...
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','Vea cabinaes y configuración de las características');
...
define('_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES','Cab características');
...
define('_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES','Cab tipo');
...
define('_JOMRES_COM_MR_VRCT_TAB_PROPERTYS','Yates');
...
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_PROPERTY','Yates');
...
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK','Cab características');
...
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Cab tipo');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_LINK','Yate');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_CLICKTOEDIT','Haga click al link de yate para editar el artículo');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT','Yate agregada');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE','Yate actualizada');
...
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_LINK','Característica de la yate');
...
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_ABBV','Característica de la yate abrev.');
...
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_HEADER_DESC','Descripción completa de característica de la yate ');
...
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_CLICKTOEDIT','Haga click al link de la característica de yate para editar el artículo');
...
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_INSERT','Característica de la yate agregada');
...
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_SAVE_UPDATE','Característica de la yate actualizada');
...
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Tipo de la Cab');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Administración de yate');
...
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Reservación hechó para la yate: ');
...
define('_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED','cabinas ocupadas');
...
define('_JOMRES_COM_DEFAULTHOTELNOTFOUND','<h1><font color=red> El yate predefinido no se encontró</h1><br>No se puede continuar. Contacte al administrador del sitio.</font>');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_OPTIN_DESC','Si usted escoge optar por esta yate en la red, entonces se listará. Se asumirá que esto es un yate activo. La red no se hace responsable de su yate. Usted debe asegurar que sus detalles sean correctos.');
...
define('_JOMRES_COM_MR_QUICKRES_STEP1_CHOOSEPROPERTY','Escoja la yate de la cual usted quiere información de disponibilidad de espacio en');
...
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_PROPERTY','Yate');
...
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETE','Borrar la característica de la yate');
...
define('_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE','Incapaz de quitar esta característica de la yate, esta asignada. Quite la característica de esta yate y vuelva a intentar.');
...
define('_JOMRES_COM_MR_PROPERTYFEATURE_DELETED','La característica de la yate se borró');
...
define('_JOMRES_COM_MR_PROPERTY_DELETE','Borre la yate');
...
define('_JOMRES_COM_MR_PROPERTY_UNABLETODELETE_MESSAGE','Incapaz de quitar esta yate, tiene los datos en la mesa: ');
...
define('_JOMRES_COM_MR_PROPERTY_DELETED','Yate se borró');
...
define('_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS','Usted no tiene los derechos de borrar esta yate.');
...
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_BUTTON','Escoja esta yate');
...
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_DESC','Cuál yate se le asociará a esta habitación?');
...
define('_JOMRES_COM_MR_QUICKRES_STEP1_SELECTPROPERTY','Escoja una yate');
...
define('_JOMRES_COM_MR_QUICKRES_STEP1_MUSTSELECTPROPERTY','Usted debe escoger una yate');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION','Descripción de yate');
...
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPERTYKEY_DESC','Si está listo ponga su web en línea, visitenos para conseguir su clave de yate. Con esta puede registrar su yate , asegurando un alcance fenomenal para sus negocios');
...
define('_JOMRES_COM_MR_PROPERTIESLISTING_OURPROPERTIES','Yates');
...
define('_JOMRES_COM_A_BOOKING','Reservar una Cab');
...
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','P.e. si estas rentando una yate, y no hay cabinaes en esa yate  .En esto caso hay que asegurar que ha registrado una habitación en esa yate.');
...
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Color de fondo por días cuando la yate/espacio está disponible');
...
define('_JOMRES_FRONT_BLACKBOOKING_BOOKTHESEROOMS','Reservaciones negras para estas cabinaes');
...
define('_JOMRES_MR_AUDIT_LISTING_PROPERTY','Derechos de yate');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Característica creada de Cab');
...
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Característica actualizada de Cab');
...
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Característica borrada de Cab');
...
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Tipo de Cab entrado');
...
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Tipo de  Cab actualizada');
...
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Tipo de Cab borrada');
...
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY','Yate creada');
...
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY','Yate actualizada');
...
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY','Yate borrada');
...
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY_FEATURE','Característica creada de yate');
...
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY_FEATURE','Característica actualizada de yate');
...
define('_JOMRES_MR_AUDIT_DELETE_PROPERTY_FEATURE','Característica borrada de yate');
...
define('_JOMRES_MR_AUDIT_EDIT_PROPERTY_SETTINGS','escenarios redactados de yate');
...
define('_JOMRES_MR_AUDIT_PUBLISH_PROPERTY','Yates publicadas');
...
define('_JOMRES_MR_AUDIT_INSERT_PROPERTY_IMAGE','Yate de Imagen nueva subida');
...
define('_JOMRES_MR_AUDIT_UPDATE_PROPERTY_IMAGE','Yate diferente de Imagen subida');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BUTTON','Selecionar esta yate');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED','Una o más de las cabinaes verificadas ya están reservadas. Si usted desea pasar estas cabinaes a Reservación negra primero cancele las reservas contra ellas.');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','Error al reservar estas habitationes, una o más de las cabinaes que usted escogió no está libre.');
...
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','cabinas incluidas en reservación negra');
...
define('_JOMRES_COM_A_PAYPAL_PENDING','Su pago de Paypal es puesto a pendiente. Una vez que el yate puede confirmar recibo del pago entonces será cambiado a confirmado.');
...
define('_JOMRES_COM_A_CLICKFORMOREINFORMATION','Informacion');
...
define('_JOMRES_COM_A_GODMANAGERWARNING','<font color=red>Cuidado. ..Usted se esta configurando como director con privilegios para todas las yates. Esto puede causar problemas .</FONT>');
...
define('_JOMRES_FRONT_PTYPE','Tipo de yate');
...
define('_JOMRES_COM_PTYPES_LIST_TITLE','Lista de Servicios');
...
define('_JOMRES_COM_PTYPES_LIST_TITLE_EDIT','Editar tipo de yates');
...
define('_JOMRES_COM_PTYPES_PTYPE','Tipo de yate');
...
define('_JOMRES_COM_PTYPES_PTYPE_DESC','Descripción de tipo de yate');
...
define('_JOMRES_COM_PTYPES_SAVED','Tipo de yate salvado');
...
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Incapaz de borrar el tipo de yate. El tipo de yate está asignado a una o más yates, por favor reasigne antes de tratar de borrar');
...
define('_JOMRES_COM_PTYPES_DELETED','Tipo(s) de yate borrados');
...
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMS','<font color=red>Error, yate sin cabinaes.</font>');
...
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOTARIFFS','<font color=red>Error, la yate no tiene tarifas.</font>');
...
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMTYPES','<font color=red>Error, la yate no tiene tipos de habitación.</font>');
...
define('_JOMRES_FRONT_PROPERTY_SWAP','Cambiar la yate');
...
define('_JOMRES_COM_MONTHSTOSHOW_DESC','En la disponibilidad de los cabinaes, cuántos meses del calendario se deberian mostrar?');
...
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Elija por favor los cabina(es) que usted desea tener fuera de servicio, y las fechas relevantes. <br>Si una cabina no tiene una marca , no se puede incluir en la Reservación negra hasta que todas los reservaciones estén completadas/canceladas.<br/> Cuándo usted ha escogido las fechas apropiadas, hacer click en el botón azul "aplica" para reexaminar la disponibilidad de la habitación.  ');
...
define('_JOMRES_FRONT_GALLERYLINK','Vea fotos de esta yate');
...
define('_JOMRES_COM_A_GALLERYLINK_DESC','Ponga una conexión a su álbum de fotografías para esta yate aquí. Se mostrará en la página de la descripción de la yate, cuando este llenada.');
...
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE_DESC','Ponga esto a sí si usted quiere mostrar la vista de Diapositivas con los detalles de la yate.');
...
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','Lo siento, no hay imágenes disponibles para esta yate');
...
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Utilice esta forma para cargar múltiples imágenes de esta yate.<br/><b>Nota:</b> cualquier imagen con el mismo nombre será sobreescrita. También note que de esta forma no carga las imágenes específicas de la yate ni la  imagen principal de la yate, usted necesitará cargarlos desde la sección de Administración de Yate.<br/><b>Nota:</b> Las imágenes cargadas aquí serán copiadas a la carpeta /images/stories/jomres/*property_uid* . Si no existe esta carpeta, será creada, a menos que por supuesto un directorio alternativo se haya especificado en la configuración.');
...
define('_JOMRES_A_GLOBALPFEATURES','Utilice las características globales de la yate');
...
define('_JOMRES_A_GLOBALPFEATURES_DESC','Ponga esto a Sí si usted quiere forzar a todas las yates a utilizar sólo las características de yate definidas por el webmaster.');
...
define('_JOMRES_A_GLOBALPFEATURES_INFO','Para asignar una imagen a esta característica, usted necesita primero cargar sus imágenes de la característica de la yate a la carpeta /images/stories/jomres/pfeatures/. ');
...
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Reservar una yate');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS','Area de navegacion');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click para cabinas y disponibilidades');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWDETAILS_TITLE','Mostrar detalles de la yate debajo de este enlace');
...
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Mostrar cabinaes y disponibiliades debajo de este enlace');
...
define('_JOMRES_COM_PROPERTYLISTDESC_DESC',"Esto limita la cantidad de caracteres mostrados cuando se describe una yate.");
...
define('_JOMRES_COM_SELFREGISTRATION','Los usuarios pueden registrar sus yates?');
...
define('_JOMRES_COM_SELFREGISTRATION_DESC','Poner a "SI" si desea que los usuarios estén habilitados para registrar sus yates sin intervención del administrador.');
...
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP1','País y región de la yate.');
...
define('_JOMRES_REGISTRATION_INSTRUCTIONS_STEP2_1','Por favor complete los detalles de la yate.');
...
define('_JOMRES_REGISTRATION_AUDIT_CREATEPROPERTY','Yate creada');
...
define('_JOMRES_REGISTRATION_NOTALLOWED',"Lo sentimos, no puede crear una yate en este sistema. Para hacerlo Ud. debe estar registrado como usuario.");
...
define('_JOMRES_REGISTRATION_CREATEDPROPERTY','Yate creada: ');
...
define('_JOMRES_NUMBEROFROOMSAVAILABLE','cabinas disponibles');
...
define('_JOMRES_NUMBEROFROOMSAVAILABLE_INFO','Por favor seleccione el número de cabinaes que requiere y el tipo.');
...
define('_JOMRES_BACKTOPROPERTYDETAILSLINK','Regresar a detalles de la yate');
...
define('_JOMRES_FRONT_ROOMTYPES','Tipo de Yate');
...
define('_JOMRES_METADATA_USEYESNO_DESC','Poner a "SI" hará que el sistema gernere metadatas para los textos repetidos en la descrición de yates. Separe las palabras con un espacio.');
...
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Seleccione el Yate que desea');
...
define('_JOMRES_AJAXFORM_AVAILABLE_DESC_SRP','Mirar si la yate está disponible para esta fecha.');
...
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Yate disponible');
...
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Yate seleccionada');
...
define('_JOMRES_COM_A_SHOWROOMINPROPERTYDETAILS','Mostrar listado de cabinaes en la página de detalles de la yate?');
...
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Mostrar enlace a listado de cabinaes en la página de detalles de la yate?');
...
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Mostrar <b>solo</b> listado de disponibilidad de cabinaes por calendario?');
...
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Cambie esto a "Sí" para desactivar despliegue del título de yate y detalles, para que sólo el calendario de disponibilidad de cabinaes sea visto en la sección de detalles de la yate. Pensado para usuarios que alquilan las cabinaes de las yates.');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Listado de cabinaes en la reservación muestra número de habitación');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Listado de cabinaes en la reservación muestra nombre de habitación');
...
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Listado de cabinaes en la reservación muestra listado de tarifas');
...
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','Usted ha configurado el sistema para una sola habitación (Ej: un apartamento, cabaña, villa) sin embargo usted tiene más de una creada. Esto puede producir errores al usar el sistema, para que pueda continuar usando el sistema para manejar una sola yate usted necesita quitar todas menos una. Por favor modifique su configuración para que la Sola Yate del Cuarto = No, entonces vaya a la Yate Admin y quite todos las cabinaes exceptúando una, para que usted sólo tenga una habitación contra esta yate.');
...
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','Ha seleccionado mas cabinaes que huespedes, click en una habitación para eliminarla de su selección');
...
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','Necesita más cabinaes');
...
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No hay Yate seleccionado');
...
define('_JOMRES_COM_LIMITROOMSLIST','Límite en cabinaes/tarifas disponibles');
...
define('_JOMRES_BOOKITNOW','Reservar: ');
...
define('_JOMRES_SEARCH_GEO_COUNTRYSEARCH','Buscar por pais');
...
define('_JOMRES_SEARCH_GEO_REGIONSEARCH','Buscar by region');
...
define('_JOMRES_SEARCH_GEO_TOWNSEARCH','Buscar by town');
...
define('_JOMRES_PATHWAY_PROPERTYLIST','Lista de Servicios');
...
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Detalles - ');
...
define('JOMRES_MAXPEOPLEINROOM','Max personas por cabinas');
...
define('_JOMCOMP_MYUSER_PUBLISHEDPROPERTIES','Yates en este sitio');
...
define('_JRPORTAL_CPANEL_LISTPROPERTIES','Lista de Yates');
...
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Nombre de Yates');
...
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Direccion de Yates');
...
define('_JRPORTAL_PROPERTIES_LEGEND','Property who\'s background colour is red have not yet had a commission rate applied to them.');
...
define('_JRPORTAL_STATS_STATTYPE_PROPERTIES','Yates - Clicks');
...
define('_JRPORTAL_ADDPROPERTY_ISSRP_DESC','Is this a property like a yate/bed and breakfast/penzion? If so, select Yes. If it is a single room property like a villa/cottage then choose No.');
...
define('_JOMRES_COM_ISTHISANMRP',"Is this property a yate/bed and breakfast/guest house/pension? ");
...
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out rooms in a property, or the property itself. Select Yes if you are offering rooms, select No if you are offering the entire property. ");
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Charter Total");
...
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"con yate en exclusivo");
...
define('_JOMRES_AJAXFORM_EXTRAS_TOTAL',"Mejore su estancia total ");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Contactanos!');
...
define('_JOMRES_BOOKINGFORM_LOOKRIGHT','Por favor seleccione su yate requerido de la lista de la derecha');
...
define('_JOMRES_SEARCH_PRICERANGES','Buscar por precios en USD $.');

...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMSCONFIGDESC','Tours-/ejendomskonfiguration');
...
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOM','Nyt tour');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMFEATURE','Ny toursfacilitet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMCLASS','Ny tourstype');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM','Tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_NAME','Toursnavn');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_NUMBER','Tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Beskrivelse af tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST','Facilitetsliste for tour');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_TITLE','Hurtig res vælg tourstyper');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_INSTRUCTIONS','Vælg venligst den krævede tourstype, ankomstdatoen for gæsten og enten antallet af nætter som gæsten bliver eller deres afrejsesdato. Til slut, angiv antallet af voksne & børn i gruppen.');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS','Desværre, vore ledige tourr kan ikke rumme så mange gæster');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ERROR_NOROOMTYPESSELECTED','<font color="red" face="arial" size="4">FEJL: Du har ikke valgt nogen tourstyper.<br>Tryk på Tilbageknappen og genindtast dine data.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP4_NOTARIFFS','Desværre, der blev ikke fundet nogen tariffer som passede til de angivne kriterier. Fortvivl ikke, det kan være at vi skal justere dine krav en smule. Prøv venligst igen, ændre antallet af dage du ønsker at overnatte, eller alternativt kan du ringe til hotellet og booke et tour via telefonen.');
...
* @ignore
*/
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','Se tours og ejendomskonfiguration');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES','Tours faciliteter');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES','Tourstyper');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK','Tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT','Tour tilføjet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_UPDATE','Tour opdateret');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_CLICKTOEDIT','Klik på tours uid link for at redigere elementet');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK','Toursfaciliteter');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_CLICKTOEDIT','Klik på toursfacilitetslinket for at redigere elementet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT','Toursfacilitet tilføjet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE','Toursfacilitet opdateret');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Forkortelse for tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Beskrevlse af tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_CLICKTOEDIT','Klik på toursklasse uid link for at redigere elementet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Tourstype tilføjet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Tourstype opdateret');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Tourstype');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAROOM','Book et tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN','Ejendomme & tourr');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_INSTRUCTIONS','Vælg venligst den ønskede tourstype, din ankomstdato og antalllet af nætter som du vil overnatte. Til slut, angiv antallet af voksne & børn i gruppen.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_INSTRUCTIONS2','Vælg venligst tourt som du nsker.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_SUBMITBUTTON_CHOOSEROOM','Jeg vil have dette tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_TITLE','Vælg tourstyper');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','Der er ingen tourr tilgængelige som kan tilfredsstille de angivne parametre');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Booking foretaget for Turudbyder: ');

/**
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Booking foretaget for tour: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_WELCOME_STRANGER','Velkommen ukendte. Inden du kan booke et tour, skal du opdatere dine detaljer under linket "Mine detaljer".');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED','Optagede tourr');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_NAVIGATETODATE','Se toursbrug fra:');
...
* @ignore
*/
define('_JOMRES_COM_A_TARIFFS_PER_DESC','Vælg ja hvis du ønsker at opkræve pr-person-pr-nat. Hvis nej, vil omkostningerne blive beregnet på en pr-tour-pr-nat basis');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKFORWEEKROOMSUSAGE','Klik for uge toursbrug startende i dag');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKONROOMFORBOOKINGINFO','Klik på et booket tour for at se bookningen');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_TAPEVIEWKEY','<br>Tours med en blå baggrund er optaget, men<br> hvis et tour har en rød tekst, så er der ikke blevet betalt depositum.<br> Hvor et tour har en stjerne ved "Booked" er gæsten forventet at ankomme på denne dag.<br> Hvis et tour har en gul tekst, så optager gæsten tourt nu.');
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RATE_RULES','Pris pr nat - pr tour ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Dit tour vil blive holdt indtil din ankomst, og tjek ind er efter kl. 14.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','Intet tilgodehavende kan gives for ikke indtagede måltider eller for Tours der ikke er brugt i hele bookingperioden. Med dette in mende anbefaler vi på det kraftigste at du bruger en ferie rejseforsikring.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_RATE_RULES','Pris pr nat - pr tour ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_ROOM','Tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE','Kan ikke fjerne dette tour, der er bookninger på det. Annuller disse booking og forsøg igen.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOM_DELETED','Tour slettet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_DELETE','Slet toursfacilitet');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Kunne ikke fjerne denne toursfacilitet, den er tildelt til nogle Tours. Fjern faciliteten fra disse Tours og forsøg igen.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_DELETED','Toursfacilitet slettet');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Slet tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Kunne ikke fjerne denne tourstype, den er tildelt et tour. Prøv at gen-tildele tourt til en anden tourstype og forsøg så igen.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Kunne ikke fjerne denne tourstype, den er tilknyttet til en tarif. Prv at gen-tildele tariffen til en anden tourstype og forsøg så igen.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Tourstype slettet');
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_DESC','Hvilken ejendom skal dit tour være tilknyttet?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_THISPROPERTYADDRESS','Tour Afgang fra:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Sæt dette til Ja for at sikre at besøgende kan booke Tours online.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','F.eks. hvis du lejer en ejendom ud, istedet for et tour i denne ejendom. Hvis det er tilfldet, skal du være sikker på at du kun har et tour registreret på hver ejendom.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cellebaggrundsfarve for dage hvor ejendom/tour er ledig');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cellebaggrundsfarve for provisorisk bookede Tours (bookinger der endnu ikke er betalt depositum for)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MESSAGES_REVIEWCHOSENROOM','Gennemse dit valgte tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_BOOKTHESEROOMS','Bloker booking på disse Tours');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_ACTUALROOMCOST','Actual tourspris: ');
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM','Oprettet tour');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM','Opdateret tour');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM','Slettet tour');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE','Oprettet toursfacilitet');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE','Opdateret toursfacilitet');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE','Slettet toursfacilitet');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE','Indsat tourstype');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE','Opdateret tourstype');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE','Slettet tourstype');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM_IMAGE','Uploadet nyt toursbillede');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM_IMAGE','Uploadet andet toursbillede');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Booket et tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED','Et eller flere af de markerede Tours er allerede booket. Hvis du ønsker at blokere booking af disse Tours skal du først annullere bookingerne på dem.');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','Der skete en fejl i forsget på at booke disse Tours, et eller flere af Toursne er ikke ledige.');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Tours inkluderet i blokeret booking');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES','Vis toursnavne?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES_DESC','Sæt dette til Ja for at vise toursnavne?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES','Vis tourstyper?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES_DESC','Sæt dette til Ja for at vise tourstyper?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SMOKING_OPTION_DESC','Vær klar over: Hvis din standardindstilling er Ja og alle dine Tours er ikke-ryger, så vil intet tour vises på listen på booking siden.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_ROOMTAX','Toursmoms');
/**
* @ignore
*/
define('_JOMRES_COM_A_ROOMTAX_DESC','Designet til det amerikanske marked. Dette er toursmomsbeløbende som gæsten vil blive opkrævet. Du kan opkræve en kombination og/eller en fast procentdel. Læg mærke til at denne moms kun bliver lagt til toursprisen.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Tourstype');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMS','<font color=red>Fejl, ejendom har ingen Tours.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMTYPES','<font color=red>Fejl, ejendom har ingen tourstyper.</font>');
...
* @ignore
*/
define('_JOMRES_COM_MONTHSTOSHOW_DESC','Hvor mange måneder skal vises for tourstilgængelighed?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Vælg venligst tourt(erne) som du vil fjerne som service, og de relevante datoer. <br>Hvis et tour ikke har en markering, kan det ikke blive inkluderet i den blokerede bookning indtil udestående bookninger er blevet gennemført/annulleret.<br/> Når du har valgt de passende datoer, så klik på den blå knap "anvend" for at gen-kontrollere tilgængelighed. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC','Sæt dette til Ja hvis du vil bruge online betalingsgateways. <b>Bemærk:</b>Dette deaktiverer ikke depositumsberegningen der vises under bookingprocessen. For at deaktivere dette kan du rediger skabelonen der viser Tours og indeslutte elementerne der refererer til depositum i  en klasse hvis font og baggrundsfarve det det samme.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS','Billeders');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWLINK','Vis link til billeders?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE','Vis billeder inline?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE_DESC','Sæt dette til Ja hvis du vil vise billederet inline med ejendomsdetaljerne.');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOW_FULLSIZE','Billeder fuld højde');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOW_THUMBSIZE','Billeder thumbnail mål højde');
/**
* @ignore
*/
define('_JOMRES_FRONT_SLIDESHOW','Billeder');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_NOIMAGES','<br />Desværre, ingen billeder tilgængelig for denne ejendom. Upload venligst nogle billeder ved at bruge masse upload funktionen hvis du vil bruge billeder funktionen.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS','Upload billeder billeder');
/**
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Brug denne formular til at uploade flere billeder af denne ejendom.<br/><b>Bemærk</b> at ethvert billede med det samme navn vil blive overskrevet. Bemærk også at denne formular ikke uploader toursspecifikke billeder eller ejendoms headerbilledet, du skal uploade disse via Ejendoms admin sektionen.<br/><b>Bemærk</b> Billeder der uploades her gemmes i mappen /images/stories/jomres/*property_uid*. Hvis denne mappe ikke eksisterer vil den blive oprettet, medmindre der er blevet angivet en alternativ mappe i konfigurationen.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Book Nu!');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS','Tour afgang fra:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Klik for Tours og tilgængelighed');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Vis Tours og tilgængelighed under dette link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOW_POPUPWIDTH','Billeder popupbrede');
/**
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOW_POPUPHEIGHT','Billeder popuphøjde');
...
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES','Brug globale tourstyper');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Sæt dette til Ja hvis du vil tvinge alle ejendomme til kun at bruge tourstype angivet af webmasteren. Du skal sætte dette til Ja hvis du ønsker at tillade søgning på tourstyper.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_INFO','For at tildele et billede til denne tourstype skal du først uploade dit tourstypebillede til mappen /images/stories/jomres/rmtypes/. ');
...
* @ignore
*/
define('_JOMRES_SHOWDETAILEDROOMINFO','Vis detaljeret toursinformation?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Antal Tours tilgængelige');
/**
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE_INFO','Vælg venligst antal Tours som du ønsker, af typen som du ønsker.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Tourstyper');
...
* @ignore
*/
define('_JOMRES_AJAXFORM_INSTRUCTIONS','Brug denne formular til at fortage din booking. Hold musen over "i" billederne for at få mere information om kolonnen. Modificer dine bookingdetaljer såsom ankomst- og afrejsedatoarrival & antal gæster. Vælg derefter de(t) ønskede tour(r) fra listen over tilgængelige Tours. Klik på et tilgængeligt tour for at tilføje det til din booking. Når du er færdig, kan du tilføje valgfrie ekstraydelser som du ønsker og angive dine adressedetaljer. Når der er udfyldt nok i formularen vil der fremkomme en send-knap så du kan bekræfte din booking.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Vælg Toursne som du ønsker');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Tilgængelige Tours');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Valgte Tours');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION','Klik nu for at tilføje dette tour til dit udvalg');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE','Klik nu for at fjerne dette tour fra dit udvalg');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','Tallet der beregnes er en procentdel af grundantallet for tourt. Hvis dette er sat til Nej så bliver tallet du angiver blot lagt til eller trukket fra grundantallet for tourt.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_POSNEG_TT','Det beregnede tal bliver lagt til eller trukket fra grundantallet beregnet for tourt. Sæt dette til Nej hvis du vil at dette skal være en rabat fra grundantallet. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Vis link til toursliste på ejendomsdetaljesiden?');

/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Vis <b>kun</b> tilgængelighedskalender/toursliste?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Skift dette til Ja for at deaktivere visning af ejendomsheadere og detaljer, så kun tourslisten/tilgængelighedskalenderen er synlig i ejendomsdetaljesektionen. Kun for brugere der udlejere enkelttoursejendomme (f.ke.s lejligheder, hytter, sommerhuse etc).');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Toursbillede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Bookingformular toursliste vis toursnummer');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Bookingformular toursliste vis toursnavn');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Bookingformular toursliste vis tariftitel');
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NUMBER','Bookingformular overlib vis toursnummer');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NAME','Bookingformular overlib vis toursnavn');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Bookingformular overlib vis tourstype');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_SMOKING','Bookingformular overlib vis toursrygning');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_ACCESS','Bookingformular overlib vis tour handicapvenligt');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FLOOR','Bookingformular overlib vis toursetage');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_MAXPEEPS','Bookingformular overlib vis tour maksimum personer');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FEATURES','Bookingformular overlib vis toursfaciliteter');
...
* @ignore
*/
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','Du har konfigureret Jomres som en enkelttoursejendom (f.eks. en lejlighed, hytte, sommerhus, villa) alligevel har du oprettet mere end et tour. Dette kan medføre fejl når du bruger Jomres, så hvis du vil fortsæette med at bruge Jomres til at styre enkelttoursejendom skal du fjerne alle tour på nær et. Modificer venligst din konfiguration så at enkelttoursejendom = Nej, og gå derefter til ejendomsadmin og fjern alle tour på når et, så du kun har et tour på denne ejendom.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','Tour er booket');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','Du har valgt flere tour end du har gæster til, klik på et toursnavn for at fjerne det fra dit udvalg');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','Du skal vælge flere Tours');
/**
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Vælg et tour');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','Ingen Tours valgt endnu');
...
* @ignore
*/
define('_JOMRES_COM_LIMITROOMSLIST','Tilgængelige Tours/tarifgrænse');
/**
* @ignore
*/
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Brug dette input til at begrænse antallet af Tours & tariffer som bliver listet i bookingformularen. Sæt det til nul hvis du ikke vil aktivere begrænsningen. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_WEEKENDDAYS_DESC','Sæt dine weekenddage. Tariffer der tillader eller forbyder weekender vil tage denne indstilling i betragtning når der genereres tourslister.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','List alle ejendomme efter tourstype.');
...
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYLIST','Tur listen');
/**
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYDETAILS','detaljer - ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY','Gen-kontroller tourstilgængelighed<br/>(Toursvalg vil blive nulstillet)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION','Ændre dit toursvalg');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"Tours(s) til");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"for tour per person ");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SLIDESHOW_LOCATION',"Show billeder above property details or below.");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERPERSON',"per person ");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Kontakt US');

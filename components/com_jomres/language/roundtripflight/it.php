...
* @ignore
*/
define("_JOMRES_COM_MR_ROOMSCONFIGDESC","Configura volo/compagnia aerea");

/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTYCONFIGDESC","Configura compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_NEWROOM","AggiungiVolo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_NEWROOMFEATURE","Aggiungi Caratteristica (volo)");
/**
* @ignore
*/
define("_JOMRES_COM_MR_NEWROOMCLASS","Nuovo tipo volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_ASSIGNUSER_AUTHORISEDDEFAULTHOTEL","compagnia aerea predefinita");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_ASSIGNUSER_CHANGEHOTEL","Cambia compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM","Volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_EB_ROOM_NAME","Nome della volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_EB_ROOM_NUMBER","Volo numero");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV","Tipo di volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_EB_ROOM_CLASS_DESC","Descrizione tipo volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST","Elenco delle caratteristiche della volo");
...
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP1_TITLE","Prenotazione rapida seleziona tipo di volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP1_INSTRUCTIONS","Per favore seleziona il tipo di volo richiesta, la data di arrivo dell' ospite e il NÂ° di giorni che l'ospite pensa di soggiornare o la data di partenza. Infine, inserisci il NÂ° di adulti e bambini");

/**
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP2_TITLE","Volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP2_PROPERTYNAME","compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE","Tipo d volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS","Non Ã¨ possibile alloggiare cosÃ¬ tanti ospiti nelle nostre Volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP2_ERROR_NOROOMTYPESSELECTED","ERRORE: Non hai selezionato nessun tipo di volo.<br />  Premere il pulsante indietro e reinserire i dati.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP4_TITLE","Seleziona una volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE","Volo e struttura");

/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_TAB_ROOM","Volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES","Caratteristiche della volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES","Tipo di volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK","Volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT","Volo aggiunta");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOM_SAVE_UPDATE","Volo aggiornata");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOM_CLICKTOEDIT","Fai clic nel link UID volo per modificare l'elemento");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK","Caratteristiche della volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMFEATURES_CLICKTOEDIT","Fai clic nel link caratteristica della volo per modificare l'elemento");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT","Caratteristica della volo aggiunta");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE","Caratteristica della volo aggiornata");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK","Tipo di volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV","Abbreviazione tipo di volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC","Descrizione tipo di volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMTYPES_CLICKTOEDIT","Fai clic nel link UID classe di volo per modificare l'elemento");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT","Tipo di volo aggiunto");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE","Tipo di volo aggiornato");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_PROPERTY_CLICKTOEDIT","Fai clic nel link UID compagnia aerea per modificare l\"elemento");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_INSERT","compagnia aerea aggiunta");
/**
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_PROPERTY_SAVE_UPDATE","compagnia aerea aggiornata");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS","Tipo di volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_PROPERTYADMIN","Amministra compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_QUICKRES_STEP1_INSTRUCTIONS","Per favore seleziona il tipo di volo richiesto, la sua data di arrivo e il nÂ° di notti di soggiorno. Infine, inserisci il nÂ° di adulti e di bambini");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_QUICKRES_STEP2_INSTRUCTIONS2","Per favore seleziona la volo richiesta.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_SUBMITBUTTON_CHOOSEROOM","Voglio questa volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_QUICKRES_STEP1_TITLE","Seleziona tipo di volo");
...
* @ignore
*/
define("_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE","Non ce nessuna volo disponibile per i parametri specificato");
...
* @ignore
*/
define("_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM","E' stata prenotata una volo: ");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_BOOKIN_NOGUESTSDUEIN","Non ce nessun ospite che arriva oggi.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_BOOKOUT_NOGUESTSDUEOUT","Non ce nessun ospite che parte oggi.");
...
* @ignore
*/
define("_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED","Volo occupate");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_STATUS_NAVIGATETODATE","Vedi utilizzo della volo");
...
* @ignore
*/
define("_JOMRES_COM_A_TARIFFS_PER_DESC","Seleziona SI se vuoi chiedere il pagamento per persona a notte, NO  per volo a notte.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_CLICKFORWEEKROOMSUSAGE","Fai clic per un utilizzo settimanale della volo fino oggi.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_TAPEVIEWKEY","<br />Le Volo su sfondo blu sono prenotate <br/>-se una volo ha il testo in rosso, il deposito non Ã¨ stato pagato.<br /> -l'asterisco indica che l'ospite arriva in data odierna.<br /> -il testo giallo indica che l'ospite sta occupando la volo.<br/>");
...
* @ignore
*/
define("_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE","Non Ã¨ prevista alcuna indennit� per pasti non comsumati o per Volo non occupate durante il periodo della prenotazione.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_INVOICE_RATE_RULES","Costo a notte/a volo ");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP1_CHOOSEPROPERTY","Sceglie la compagnia aerea di cui vuoi conoscere la disponibilit� ");
...
* @ignore
*/
define("_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_ROOM","Volo");
/**
* @ignore
*/
define("_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_PROPERTY","compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_ROOM_DELETED","Volo eliminata");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMFEATURE_DELETE","Elimina la caratteristica della volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE","Non Ã¨ possibile eliminare questa caratteristica della volo, perchÃ¨ e assegnata ad altre Volo. Elimina la caratteristica da quelle Volo e riprova.");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMFEATURE_DELETED","Caratteristica della volo eliminata");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTYFEATURE_DELETE","Elimina la caratteristica della compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTYFEATURE_UNABLETODELETE","Non Ã¨ possibile eliminare questa caratteristica della compagnia aerea, perchÃ¨ Ã¨ assegnata ad altre compagnia aerea. Elimina la caratteristica da quelle compagnia aerea e reprova.");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTYFEATURE_DELETED","Caratteristica della compagnia aerea eliminata");

/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMCLASS_DELETE","Elimina il tipo di volo");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS","Non Ã¨ possibile eliminare questo tipo di volo, perchÃ¨ Ã¨ stato assegnato ad altre Volo.");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS","Non Ã¨ possibile eliminare questo tipo d volo, perchÃ¨ Ã¨ stato assegnato a una tariffa.");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ROOMCLASS_DELETED","Tipo di volo eliminato");

/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTY_DELETE","compagnia aerea eliminata");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTY_UNABLETODELETE_MESSAGE","Non Ã¨ possibile eliminare questa compagnia aerea, ci sono dati nella tabella: ");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTY_DELETED","compagnia aerea eliminata");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTY_DELETE_NORIGHTS","Tu non hai sufficienti diritti per eliminare questa compagnia aerea.");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_BUTTON","Scegli questa compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_DESC","Con quale compagnia aerea sar� associata la volo?");
/**
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP1_SELECTPROPERTY","Seleziona una compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_MR_QUICKRES_STEP1_MUSTSELECTPROPERTY","Devi selezionare una compagnia aerea");
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPDESCRIPTION","Descrizione della compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_AREAACTIVITIES","Attivita");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPERTYKEY","La tua chiave di compagnia aerea in Jomres.net");

/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTIESLISTING_OURPROPERTIES","Nostra compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_MR_PROPERTIESLISTING_THISPROPERTYADDRESS","Indirizzo di Linea Aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_A_BOOKING","Volo prenotazione");
...
* @ignore
*/
define("_JOMRES_COM_A_SINGLEROOMPROPERTY","Compagnia aerea di una sola volo");
/**
* @ignore
*/
define("_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC","Ex. Un'appartamento per vacanze. In questo caso, assicurarti di avere una sola volo registrata in ciascuna compagnia aerea.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_AVLCAL_INBGCOLOUR","Colore dello sfondo della casella per i giorni quando Ã¨ diponibile la volo/compagnia aerea.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR","Sfondo della casella per le Volo con la prenotazione provvisoria (prenotazioni con nessun deposito fatto)");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MESSAGES_CHOOSEAROOM","Scegli una volo");
/**
* @ignore
*/
define("_JOMRES_FRONT_MESSAGES_REVIEWCHOSENROOM","Vedi la Volo scelta");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_BLACKBOOKING","Volo indisponibili");
/**
* @ignore
*/
define("_JOMRES_FRONT_BLACKBOOKING_NONE","Nessuna volo indisponibile");
/**
* @ignore
*/
define("_JOMRES_FRONT_BLACKBOOKING_NEW","Nuova volo indisponiblie");
/**
* @ignore
*/
define("_JOMRES_FRONT_BLACKBOOKING_BOOKTHESEROOMS","Registra questa volo fra le indisponibili");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_INVOICE_ACTUALROOMCOST","Costo della volo: ");
...
* @ignore
*/
define("_JOMRES_MR_AUDIT_LISTING_PROPERTY","Diritti di compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_ROOM","Volo creata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_ROOM","Volo aggiornata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_DELETE_ROOM","Volo eliminata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_ROOM_FEATURE","Caratteristica della volo creata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_ROOM_FEATURE","Caratteristica della volo aggiornata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_DELETE_ROOM_FEATURE","Caratteristica della volo eliminata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_ROOM_TYPE","Tipo di volo inserito");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_ROOM_TYPE","Tipo di volo aggiornato");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_DELETE_ROOM_TYPE","Tipo di volo eliminato");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_PROPERTY","compagnia aerea creata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_PROPERTY","compagnia aerea aggiornata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_DELETE_PROPERTY","compagnia aerea eliminata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_PROPERTY_FEATURE","Caratteristica della compagnia aerea creata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_PROPERTY_FEATURE","Caratteristica della compagnia aerea aggiornata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_DELETE_PROPERTY_FEATURE","Caratteristica della compagnia aerea eliminata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_EDIT_PROPERTY_SETTINGS","Impostazione della compagnia aerea eliminata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_PUBLISH_PROPERTY","compagnia aerea pubblicata");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_PROPERTY_IMAGE","Caricare nuova immagine  della compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_PROPERTY_IMAGE","Caricare differente immagine  della compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_MR_AUDIT_INSERT_ROOM_IMAGE","nuova immagine della compagnia aerea caricata");
/**
* @ignore
*/
define("_JOMRES_MR_AUDIT_UPDATE_ROOM_IMAGE","differente immagine  della compagnia aerea caricata");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_MR_AUDIT_BOOKED_ROOM","Prenotazione una volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BUTTON","Seleziona questa compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS","Volo Indisponibili");
/**
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED","Una o piÃ¹ Volo verificate sono  gi�  prenotate. Se vuoi aggiungerla/e alle indisponibili  prima Ã¨ necessario annullare le prenotazioni gi� effetuate.");
/**
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR","Errore durante la prenotazione, una o piÃ¹  Volo selezionate non sono libere.");
/**
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT","Volo inclusa fra le indisponibili");
/**
* @ignore
*/
define("_JOMRES_COM_MR_BLACKBOOKINGS_DELETEBLACKBOOKING","Elimina volo indisponibile");
/**
* @ignore
*/
define("_JOMRES_COM_MR_BLACKBOOKINGS_VIEWBLACKBOOKING","Volo indisponibili");
/**
* @ignore
*/
define("_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_NOBBOOKINGS","Nessuna volo indisponibile da elencare");
...
* @ignore
*/
define("_JOMRES_COM_A_SHOWROOMNAMES","Mostrare i nomi delle Volo");
/**
* @ignore
*/
define("_JOMRES_COM_A_SHOWROOMNAMES_DESC","Impostare questo in SI  per mostrare i nomi delle Volo");
/**
* @ignore
*/
define("_JOMRES_COM_A_SHOWROOMTYPES","Mostrare le tipologie di volo");
/**
* @ignore
*/
define("_JOMRES_COM_A_SHOWROOMTYPES_DESC","Impostare questo in SI  per mostrare i tipi di Volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_A_SMOKING_OPTION_DESC"," Se la sua opzione prefinita Ã¨ in SI e tutte le tue Volo sono non fumatori, nessuma volo sar� mostrata nella pagina d'elenco in prenotazione.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_A_GODMANAGERWARNING","<font color=red>Avvertenza.... sei registrato come  direttore con privilegio per tutte le compagnia aerea. Si conscio che questo potrebbe causare problemi in Jomres.</FONT>");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_A_ROOMTAX","Imposta della volo");
/**
* @ignore
*/
define("_JOMRES_COM_A_ROOMTAX_DESC","Ex imposta di soggiorno. Ã possibile applicare un' importo  fisso o una percentuale da applicate al costo della volo.");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_TARIFFS","Tariffe");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_TARIFFS_ROOMTYPE","Tipo di volo");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_FRONT_PTYPE","Tipo di compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_LIST_TITLE","Elencare tipi di compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_LIST_TITLE_EDIT","Modificare tipo di compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_PTYPE","Tipo di compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_PTYPE_DESC","Descrizione del tipo di compagnia aerea");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_SAVED","Tipo di  compagnia aerea salvato");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_UNABLETO_DELETE","Non Ã¨ possibile eliminare il tipo di compagnia aerea. Il tipo di compagnia aerea Ã¨ assegnato a una o piÃ¹ compagnia aerea, assegna di nuovo le propiet� prima provare ad eliminare.");
/**
* @ignore
*/
define("_JOMRES_COM_PTYPES_DELETED","Tipo di compagnia aerea eliminati");

/**
* @ignore
*/
define("_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMS","<font color=red>Errore, la compagnia aerea non ha Volo.</font>");
/**
* @ignore
*/
define("_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOTARIFFS","<font color=red>Errore, la compagnia aerea non ha tariffe.</font>");
/**
* @ignore
*/
define("_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMTYPES","<font color=red>Errore, la compagnia aerea non ha tipi di volo.</font>");

/**
* @ignore
*/
define("_JOMRES_FRONT_PROPERTY_SWAP","Cambiare compagnia aerea");
/**
* @ignore
*/
...
* @ignore
*/
define("_JOMRES_COM_MONTHSTOSHOW_DESC","Nella disponibit� della volo, quanti mesi del calendario devono essere mostrati");
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Seleziona la volo che desideri tenere fuori servizio, e le date. Se la volo non ha il ceck selezionato, non potr� essere inclusa nelle indisponibili fino a che la prenotazione non sar� cancellata.<br/> Quando hai selezionato le date appropriate, clicca il bottune blu applicare ricontrolla la disponibilit�. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GATEWAY_USEGATEWAYS_DESC','Seleziona SI se usi il pagamento online.. <b>Note:</b>This does not switch off the deposit calculation showed during the booking process. To disable this you can edit the templates that show posti and remove the elements that refer to deposits.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Usa questo form per caricare le tue immagini.<br/><b>Nota</b> ogni immagine con lo stesso nome sar� sovrascritta. Le immagini relative alla compagnia aerea o alle specifiche Volo vanno caricate nella sezione apposita.<br/>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Prenota ora!');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKTHISPROPERTY','Prenota questa compagnia aerea');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Mostra la disponibilit� di Volo');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show posti and availability below this link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES','Utilizza tipo sede globale');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Impostare su SI se vogliamo forzare le propriet6a ad utilizzare solo i tipi sede predefiniti dal webmaster.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_INFO','Per assegnare una immagine a questo tipo sede dobbiamo prima caricare una immagine nella cartella /images/stories/jomres/rmtypes/. ');
...
* @ignore
*/
define('_JOMRES_JAVASCRIPT_','Elementi evidenziati in rosso sono richiesti.');
/**
* @ignore
*/
define('_JOMRES_COM_SELFREGISTRATION','Gli utenti possono registrare le proprie proprieta agrave;?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SHOWDETAILEDROOMINFO','Mostra informazioni della sede dettagliate?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Tipo di volo');
...
* @ignore
*/
define('_JOMRES_AJAXFORM_INSTRUCTIONS','Usare questa form per fare le vostre prenotazioni. Portare il cursore del mouse sopra la "i" immagine per maggiori informazioni circa la colonna. Modificare la vostra particolare prenotazione come data di arrivo e partenza e numero di persone, pi selezionare la sede richiesta dalla lista delle. Cliccare qualsiasi sede disponibile per aggiongerla alla prenotazione. Quando fatto, possiamo aggiungere extra aggiuntivi opzionali che possono richiedere il vostro indirizzo. Quando la form ha abbasede dati informativi troverete il pulsante per inviare la vostra prenotazione e confermare.');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_INSTRUCTIONS_SRP','Usare questa form per fare le vostre prenotazioni. Portare il cursore del mouse sopra la "i" immagine per maggiori informazioni circa la colonna. Modificare la vostra particolare prenotazione come data di arrivo e partenza e numero di persone. Quando fatto, possiamo aggiungere extra aggiuntivi opzionali che possono richiedere il vostro indirizzo. Quando la form ha abbasede dati informativi troverete il pulsante per inviare la vostra prenotazione.');
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Seleziona la sede che hai richiesto');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Sede disponibili');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Volo selezionate');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM','Per Volo per persona:');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION','Clicca adesso per aggiungere la sede dalla tua selezione');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE','Clicca adesso per rimuovere la sede dalla tua selezione');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','La figura calcolata &egrave; una percentuale sulla base di figure calcolate per la sede. Se questa &egrave; impostata su NO la figura &egrave; semplicemente specificata da aggiungere o sottrarre dalla base del valore della sede.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_POSNEG_TT','La figuara calcolata &grave; aggiunta o rimossa dalla base di figura calcolata per la sede. Impostare questo su NO se vogliamo sia uno sconto dalla base della figura. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Mostra <b>solo</b> calendario disponibilit&agreve;/Lista sede?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Form prenotazione lista stanze mostra il numero sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Form prenotazione lista stanze mostra il nome sede');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NUMBER','Form prenotazione overlib mostra numero sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NAME','Form prenotazione overlib mostra nome sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Form prenotazione overlib mostra tipo sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_SMOKING','Form prenotazione overlib mostra sede fumatori');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_ACCESS','Form prenotazione overlib mostra accesso disabili sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FLOOR','Form prenotazione overlib mostra piano sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_MAXPEEPS','Form prenotazione utilizza overlib per mostrare il massimo numero di persone per sede');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FEATURES','Form prenotazione utilizza overlib per mostrare le caratteristiche della sede');
...
* @ignore
*/
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','Avete configurato Jomres come singola propriet&agrave; (es  appartmento, cottage, villa) anche se avete creato una sede. Questo potrebbe risultare un errore quando utilizziamo Jomres, se volete continuare ad utilizzare Jomres per gestire una singola sede dovete rimuovere delle stanze. Modificate la vostra configurazione in propriet&agrave; singola sede = No, andate amministrazione prpriet6agrave; e rimuovere tutte le stanze eccetto una, quindi avremo un unica sede.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','sede prenotata');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','Avete scelto pi&ugrave, stanze che ospiti, clicca su un nome sede per rimuoverlo dalla selezione');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','Desideri scegliere');
/**
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Seleziona una sede');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','Nessuna sede selezionata ancora');
...
* @ignore
*/
define('_JOMRES_SRP_WEHAVENOVACANCIES','Nessuna sede libera al momento!');
...
* @ignore
*/
define('_JOMRES_COM_USERIS_SUPERPROPERTYMANAGER','Super Servizio Manager');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the posti list.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_PTYPES','List all properties by property tipo.');
/**
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','List all properties by room tipo.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYNAME','Servizio Name');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYREGION','Servizio Region');
/**
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYTOWN','Servizio Town');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYLIST','Elenco di tutti i fornitori di viaggio a Los Roques');
/**
* @ignore
*/
define('_JOMRES_PATHWAY_PROPERTYDETAILS','Servizio details - ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY','Re-checking room availability<br/>(Posti selection will be reset)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Posti image');
/**
* @ignore
*/
...
Normal mode: You will have one tariff for each room tipo that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each room/property tipo. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference posti and tariffs to room/property types and allows you to configure posti and prices on the same page.<br/>
...
Advanced mode lets you create a room and associate it with a room tipo. You then create a tariff and associate THAT with a room tipo. Using this method it is possible to \"layer\" tariffs over each other, for example a room tipo \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a room or tariff from a room/property tipo, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of posti and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
* @ignore
*/
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show posti list in property details page?');
/**
* @ignore
*/
define('JOMRES_PROPERTYTYPE','Servizio tipo');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_MYUSER_PROPERTYTYPE','Servizio tipo');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_TITLE_DESC_FULL','Most businesses will recalculate room prices based on the number of posti of a required tipo that are available on a given date. This allows them to offer discounts on a room tipo that isn\'t busy during a given period with the aim of attracting business that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of posti of a selected tipo are available in the property on a given day.<br/> The days threashold defines the number of days that the arrival date must be within before room prices are adjusted by this feature, then the percentages options allow you to configure the percentage of posti that can be available before a given discount is applied.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE10','Percentage posti occupied < 10%');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE25','Percentage posti occupied < 25%');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE50','Percentage posti occupied < 50%');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE75','Percentage posti occupied < 75%');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_ROOMTYPE','Posti tipo ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_NOTDISCOUNTED',' Posti price not discounted ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Jomres will show the map in your Servizio Details page.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_AMEND','Amend Booking - Servizio Selection');
/**
* @ignore
*/
define('_JOMCOMP_AMEND_SELECTPROPERTY','Select New Servizio');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_PROPERTYNAME','Servizio name');
/**
* @ignore
*/
define('_JRPORTAL_PROPERTIES_PROPERTYADDRESS','Indrizzo di linea ae4rea');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_VIEWPROPERTY','Servizio view');
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_ROOMUSAGE','Posti usage');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_LISTBOOKINGS_HEADER_PROPERTY_ID','Servizio id');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have property tipo specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this property tipo so posti become, for example, DVDs, etc.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out posti in a property, or the property itself. Select Yes if you are offering posti, select No if you are offering the entire property. ");
// Jomres v3.0.6
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Ritorno di volo totali");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_NIGHTS',"Al punti volo(s) a");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per volo per persona");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_EXTRAS_TOTAL',"Migliora il tuo soggiorno totale");
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_PRICE_SUMMARY',"Prezzo Sintesi");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERPERSON',"per persona per volo");
...
define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL','Contattaci');

define('_JOMRES_FRONT_MR_MENU_CONTACTHOTEL_SUBJECT','Servizio enquiry from ');
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min posti already selected');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of posti already selected in booking before tariff/room tipo combo can be offered. Allows you to have discounted tariffs when more than N posti are already selected. ');

/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max posti already selected');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of posti already selected in booking before tariff/room combo is no longer offered. Allows you to stop offering this room tipo/tariff combination once N posti have been selected in the booking form. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_PROPERTY_URL_PTYPE','Add property tipo to url');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_SEARCH_URL_PTYPE','Search URL Structure - Servizio tipo');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_PTYPE','Search URL Structure - Default property tipo');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Per days X posti selected');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_PRICERANGES','cerca prezzi in USD$');
/**
* @ignore
*/

...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMSCONFIGDESC','Cabins/yacht Configuration');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTYCONFIGDESC','Yacht Configuration');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOM','New cabin');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMFEATURE','New cabin feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_NEWROOMCLASS','New cabin/yacht type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNUSER_CHANGEHOTEL','Change yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EDITBOOKING_TAB_ROOM','Cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_GUEST_JOMRES_TOWN_EXPL','Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_GUEST_REASON_HOTELCANCELLED','yacht cancelled');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_NAME','Cabin name');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_NUMBER','Cabin');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_FLOOR','Deck');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_ABBV','Cabin/Yacht type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_CLASS_DESC','Cabin/yacht type description');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_FEATURES_LIST','Cabin features list');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_TITLE','Quick Res select cabin/yacht types');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the cabin/yacht type required, the arrival date of the guest and either the number of nights the guest is staying or their departure date. Finally, enter the number of adults & children in the contingent.');

/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TITLE','Our cabins');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMFLOOR','Deck');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ROOMTYPE','Cabin/yacht type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_TOOMANYGUESTS','Sorry, but our available cabins cannot service this many guests');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_NOROOMSINRANGE','<font color="red" face="arial" size="3">Sorry, the yacht can not offer accommodation for this period. Please return to the calendars and review the availability displayed there.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP2_ERROR_NOROOMTYPESSELECTED','<font color="red" face="arial" size="4">ERROR: You did not select any cabin/yacht types.<br>Press the back button & re-enter your data.</font>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VIEWROOMSPROPERTYCONFIG_TITLE','View cabins & yacht config');

/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOM','Cabins');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOMFEATURES','Cab features');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_TAB_ROOMTYPES','Cab types');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_LINK','Cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_PROPERTY','Yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_HEADER_FLOOR','Deck');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_INSERT','Cabin added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_SAVE_UPDATE','Cabin updated');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOM_CLICKTOEDIT','Click the cabin uid link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_HEADER_LINK','Cab features');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_CLICKTOEDIT','Click the cabin features link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_INSERT','Cabin feature added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMFEATURES_SAVE_UPDATE','Cabin feature updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_LINK','Cabin types');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_ABBV','Cabin/yacht type abbreviation');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_HEADER_DESC','Cabin/yacht type description');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_CLICKTOEDIT','Click the cabin class uid link to edit the item');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_INSERT','Cabin/yacht type added');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_ROOMTYPES_SAVE_UPDATE','Cabin/yacht type updated');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_LINK','Yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_TOWN','Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_CLICKTOEDIT','Click the yacht uid link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTYFEATURES_CLICKTOEDIT','Click the yacht feature uid link to edit the item');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_LISTTARIFF_ROOMCLASS','Cabin/yacht type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BOOKAROOM','Book a Cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_INSTRUCTIONS','Please select the cabin/yacht type required, your arrival date and the number of nights you will be staying. Finally, enter the number of adults & children in the contingent.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_INSTRUCTIONS2','Please select the cabin that you require.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_SUBMITBUTTON_CHOOSEROOM','I want this cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP1_TITLE','Select cabin/yacht types');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_QUICKRES_STEP2_NOROOMSINRANGE','There are no cabins available able to satisfy the parameters specified');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_SUBJECT_INTERNETBOOKINGMADE','Booking made for yacht: ');

/**
* @ignore
*/
define('_JOMRES_FRONT_MR_EMAIL_TEXT_ROOM','Booking made for cabin: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_WELCOME_STRANGER','Welcome stranger. Before you can Book a Cabin, you need to update your details under the "My Details" link.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_ROOMSOCCUPIED','Cabins occupied');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_STATUS_NAVIGATETODATE','View cabin usage from:');
...
* @ignore
*/
define('_JOMRES_COM_A_TARIFFS_PER_DESC','Select Yes if you want to charge per-person-per-night. If no, then costs will be calculated on a per-cabin-per-night basis');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKFORWEEKROOMSUSAGE','Click for week cabin usage starting today');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_CLICKONROOMFORBOOKINGINFO','Click on a booked cabin to view the booking');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_BOOKED','Cabins booked');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_TAPEVIEWKEY','<br>Cabins with a blue background are booked, however<br> if a cabin has red text, then no deposit has been paid.<br> Where a cabin has a star against "Booked" then the guest is expected to arrive on this day.<br> If a cabin has yellow text, then the guest is currently occupying the cabin.');
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RATE_RULES','Cost per night - per cabin ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_CHECKIN','Your cabin will be held until your arrival, and check in is after 2pm.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_CONFIRMATION_RESERVATION_SMALLPRINT_NOALLOWANCE','No allowance can be made for meals not taken or for cabins not occupied for the full period of the booking. With this in mind we strongly recommend that you use a holiday insurance facility.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_RATE_RULES','Cost per night - per cabin ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_DEFAULTHOTELNOTFOUND','<h1><font color=red> Default yacht not found</h1><br>Cannot continue. Contact your site administrator.</font>');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_OPTIN_DESC','If you choose to opt this yacht into the jomres network, then it will be listed at jomres.net. Please note, it will be assumed that this is a live yacht. Paxsoft.net cannot be held responsible for your yacht. You must ensure that your details are correct.');
...
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_CHOOSEPROPERTY','Choose the yacht you want cabin availability information on');
...
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_ROOM','Cabin');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_ROOMBOOKINGLISTING_PROPERTY','Yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOM_UNABLETODELETE','Unable to remove this cabin, there are bookings against it. Cancel those bookings then retry.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOM_DELETED','Cabin deleted');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_DELETE','Delete cabin feature');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_UNABLETODELETE','Unable to remove this cabin feature, it is assigned to some cabins. Remove the feature from those cabins and retry.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMFEATURE_DELETED','Cabin feature deleted');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETE','Delete cabin/yacht type');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_ROOMS','Unable to remove this cabin/yacht type, it is assigned to a cabin. Try re-assigning the cabin to another cabin/yacht type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_UNABLETODELETE_TARIFFS','Unable to remove this cabin/yacht type, it is assigned to a tariff. Try re-assigning the tariff to another cabin/yacht type then try again.');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ROOMCLASS_DELETED','Cabin/yacht type deleted');
...
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTY_UNABLETODELETE_MESSAGE','Unable to remove this yacht, it has data in table: ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_BUTTON','Choose this yacht');
/**
* @ignore
*/
define('_JOMRES_COM_MR_ASSIGNROOMTOTHISPROPERTY_DESC','Which yacht will your cabin be associated with?');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_SELECTPROPERTY','Select a yacht');
/**
* @ignore
*/
define('_JOMRES_COM_MR_QUICKRES_STEP1_MUSTSELECTPROPERTY','You must select a yacht');
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_AREAACTIVITIES','Sailing area');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_DRIVINGDIRECTIONS','Getting there!');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPERTYKEY','Your Paxsoft.net yacht key');
/**
* @ignore
*/
define('_JOMRES_COM_MR_VRCT_PROPERTY_HEADER_PROPERTYKEY_DESC','When you are ready to put your website up on the web, visit <a href="http://www.paxsoft.net" target="_blank">Paxsoft.net</a> for your yacht key. With that jomres can register your yacht on the Paxsoft Network, ensuring that your reach the widest possible audience for your business.');

/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_OURPROPERTIES','Our yachts');
/**
* @ignore
*/
define('_JOMRES_COM_MR_PROPERTIESLISTING_THISPROPERTYADDRESS','Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_VISITORSCANBOOKONLINE_DESC','Set this to Yes to ensure that visitors can book cabins online.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKING','Booking cabins');
...
* @ignore
*/
define('_JOMRES_COM_A_SINGLEROOMPROPERTY_DESC','EG you are renting out a yacht, rather than cabins in that yacht. If this is the case, then you must make sure that you only have the one cabin registered against each yacht.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_INBGCOLOUR','Cell bgcolour for days when yacht/cabin is available');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_PROVISIONALCOLOUR','Cell bgcolour for provisionally booked cabins (bookings for which a deposit has not been taken)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MESSAGES_REVIEWCHOSENROOM','Review your chosen cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_BOOKTHESEROOMS','Black book these cabins');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_INVOICE_ACTUALROOMCOST','Actual cabin cost: ');
...
* @ignore
*/
define('_JOMRES_COM_A_PAYPAL_EMAIL_DESC','Note: To use paypal you must goto your paypal account & enable Autoreturn. (Profile/Website Payment Preferences) Set Auto Return: On, Set Return URL: http://www.domain.com/index.php?option=com_jomres&task=bookacabin&action=success  ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_LISTING_PROPERTY','Yacht rights');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_INSERT_ROOM','Created cabin');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_UPDATE_ROOM','Updated cabin');
/**
* @ignore
*/
define('_JOMRES_MR_AUDIT_DELETE_ROOM','Deleted cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_MR_AUDIT_BOOKED_ROOM','Booked a cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_BUTTON','Select this yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSBOOKED','One or more of the cabins checked are already booked. If you wish to Black Book these cabins you first need to cancel the bookings against them.');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_STAGE2_ERROR','There was an error attempting to book these cabins, one or more of the cabins you selected is not free.');
/**
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_ADMIN_BLACKBOOKINGS_ROOMSSUBJECT','Cabins included in black booking');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_PAYPAL_PENDING','Your payment status from paypal is set to Pending. Once the yacht can confirm receipt of payment then the booking will be changed to confirmed.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES','Show cabin names?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMNAMES_DESC','Set this to Yes to show cabin names?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES','Show cabin/yacht types?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMTYPES_DESC','Set this to Yes to show cabin/yacht types?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SMOKING_OPTION_DESC','Be aware: If your default option is Yes and all your cabins are No smoking, then no cabins will show up in the bookings page listing.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GODMANAGERWARNING','<font color=red>Warning...You are logged in as a manager with privileges for all properties. Be aware that this may cause problems when performing some functions within Paxsoft.</FONT>');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_ROOMTAX','Cabin tax');
/**
* @ignore
*/
define('_JOMRES_COM_A_ROOMTAX_DESC','Designed for the American market. These are the cabin tax amounts that will be charged to the guest. You can charge a combination and/or of fixed and percentage figures. Note that these taxes are only applied to the cost of the cabin.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_TARIFFS_ROOMTYPE','Cabin/yacht type');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_UNABLETO_DELETE','Unable to delete yacht type. Yacht type is assigned to one or more properties, please re-assign them before trying to delete');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMS','<font color=red>Error, yacht has no cabins.</font>');
/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOTARIFFS','<font color=red>Error, yacht has no tariffs.</font>');
/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_BOOKINGCHECK_NOROOMTYPES','<font color=red>Error, yacht has no cabin/yacht types.</font>');

/**
* @ignore
*/
define('_JOMRES_FRONT_PROPERTY_SWAP','Change yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MONTHSTOSHOW_DESC','In the cabin availability, How many months of the calendar should be shown?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_BLACKBOOKING_DESC','Please choose the cabin(s) you wish to take out of service, and the relevant dates. <br>If a cabin does not have a check mark against it, it cannot be included in the black booking until any outstanding bookings have been completed/cancelled.<br/> When you have selected the appropriate dates, click the blue "apply" button to re-check cabin availability. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_GALLERYLINK','View photos of this yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_GALLERYLINK_DESC','Put a link to your photo album for this yacht here. It will show on the yacht description page, when filled.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SLIDESHOWS_SHOWSLIDESHOWINLINE_DESC','Set this to yes if you want to show the slideshow inline with the yacht details.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_IMAGEUPLOADS_INFO','Use this form to upload multiple images of this yacht.<br/><b>Note</b> that any images with the same name will be overwritten. Also note that this form does not upload cabin specific images or the yacht header image, you will need to upload them from the Yacht Admin section.<br/><b>Note</b> Images uploaded here will be written to the /images/stories/jomres/*yacht_uid* folder. If this folder does not exist, it will be created, unless of course an alternative directory has been specified in the configuration.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES_DESC','Set this to Yes if you want to force all properties to use only the yacht features defined by the webmaster.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALPFEATURES_INFO','To assign an image to this feature you first need to upload your yacht feature images to the /images/stories/jomres/pfeatures/ folder. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_MR_MENU_BOOKAROOM','Book a Cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS','Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS','Click for Cabins and availability');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWADDRESS_TITLE','Show Cruising Area information below this link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BASICTEMPLATE_SHOWROOMS_TITLE','Show cabins and availability below this link');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES','Use global cabin/yacht types');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_DESC','Set this to Yes if you want to force all properties to use only the cabin/yacht types defined by the webmaster. You need to set this to Yes if you intend to allow searching via cabin/yacht types.');
/**
* @ignore
*/
define('_JOMRES_A_GLOBALROOMTYPES_INFO','To assign an image to this cabin/yacht type you first need to upload your cabin/yacht type images to the /images/stories/jomres/rmtypes/ folder. ');
...
* @ignore
*/
define('_JOMRES_SHOWDETAILEDROOMINFO','Show detailed cabin information?');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE','Number of cabins available');
/**
* @ignore
*/
define('_JOMRES_NUMBEROFROOMSAVAILABLE_INFO','Please select the number of cabins you require, of the type you require.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_FRONT_ROOMTYPES','Cabin/yacht types');
...
* @ignore
*/
define('_JOMRES_METADATA_USEYESNO_DESC','If you set this to Yes, then Paxsoft will use text that is repeated from yacht description & Yacht Listings pages to generate Metadata. Seperate words with a space.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLE_DESC','Select the cabins that you require');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_AVAILABLEROOMS','Available cabins');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_SELECTEDROOMS','Selected cabins');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_BILLING_ROOM_TOTAL','Yacht Charter');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION','Click now to add this cabin to your selection');
/**
* @ignore
*/
define('_JOMRES_AJAXFORM_CLICKHERECAPTION_REMOVE','Click now to remove this cabin from your selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_ISPERCENTAGE_TT','The figure calculated is a percentage of the Base figure calculated for the cabin. If this is set to no then the figure you specify is simply added or subtracted from the base cabin value.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_VARIANCES_POSNEG_TT','The figure calculated is added to or removed from the Base figure calculated for the cabin. Set this to No if you want this to be a discount from the base figure. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMINPROPERTYDETAILS','Show availability calendar in yacht details page?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWROOMSLISTLINK','Show link to availability calendar in yacht details page?');

/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL','Show <b>only</b> Availability calendar/Cabins list?');
/**
* @ignore
*/
define('_JOMRES_COM_A_SHOWONLYAVLCAL_DESC','Switch this to Yes to disable display of the yacht header and details, so that only the cabins list/availability calendar is viewable in the yacht details section. Only really intended for users renting out single cabin properties (eg apartments, cottages etc).');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNO','Booking form cabin list show cabin number');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMNAME','Booking form cabin list show cabin name');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWTARIFFTITLE','Booking form cabin list show tariff title');
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NUMBER','Booking form overlib show cabin number');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_NAME','Booking form overlib show cabin name');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_TYPE','Booking form overlib show cabin/yacht type');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_SMOKING','Booking form overlib show cabin smoking');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_ACCESS','Booking form overlib show cabin disabled access');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FLOOR','Booking form overlib show cabin deck');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_MAXPEEPS','Booking form overlib show cabin maximum people');
/**
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORMOVERLIB_SHOWROOM_FEATURES','Booking form overlib show cabin features');
...
* @ignore
*/
define('_JOMRES_SINGLEROOMPROPERTY_ERROR','You have configured Paxsoft as a single cabin yacht (eg an apartment, cottage, villa) however you have more than one cabin created. This may result in errors when using Paxsoft, so if you are going to continue using Paxsoft to manage a single cabin yacht you need to remove all but one of the cabins. Please modify your configuration so that Single Cabin Yacht = No, then go to Yacht Admin and remove all cabins except one, so that you only have one cabin against this yacht.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_AVLCAL_BOOKING_KEY','Cabin is booked');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_MORE_ROOMS_THAN_GUESTS','You have chosen more cabins than you have guests, click on a cabin name to remove it from your selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_CHOOSE_MORE_ROOMS','You need to choose more cabins');
/**
* @ignore
*/
define('_JOMRES_BOOKINGFORM_MONITORING_SELECT_A_ROOM','Select a cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SRP_WEHAVEVACANCIES','We have a Yacht for You and your Party!');
/**
* @ignore
*/
define('_JOMRES_BOOKINGFORM_NOROOMSSELECTEDYET','No cabins selected yet');
...
* @ignore
*/
define('_JOMRES_COM_LIMITROOMSLIST','Available cabins/tariff limit');
/**
* @ignore
*/
define('_JOMRES_COM_LIMITROOMSLIST_DESC','Use this input to limit the number of available cabins & tariffs that are listed in the booking form. Set it to zero if you do not want limiting enabled. ');
/**
* @ignore
*/
define('_JOMRES_SRP_WEHAVENOVACANCIES','No Yacht Charters at this time!');
...
* @ignore
*/
define('_JOMRES_COM_WEEKENDDAYS_DESC','Set your weekend days. Tariffs that allow or disallow weekends will take this setting into account when generating the cabins list.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_GEO_TOWNSEARCH','Search by Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SEARCH_PTYPES','List all properties by yacht type.');
/**
* @ignore
*/
define('_JOMRES_SEARCH_RTYPES','List all properties by cabin/yacht type.');
...
* @ignore
*/
define('_JOMRES_SORTORDER_PROPERTYTOWN','Yacht Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_RECHECKINGROOMAVIALABILITY','Re-checking cabin availability<br/>(Cabin selection will be reset)');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_BOOKINGFORM_BLOCKUIMESSAGES_CHANGINGROOMSELECTION','Changing your cabin selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_A_BOOKINGFORM_SHOWROOMIMAGE','Cabin image');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_CALENDARNOTE','Note! These options only affect the language format in modules. To adjust the javascript langauge format for a given yacht please edit that javascript calendar options within that yacht');
/**
* @ignore
*/
...
Normal mode: You will have one tariff for each cabin type that is valid for the next 10 years.<br/>
Micromanage: You can modify the price for each and every day for each cabin/yacht type. <br/>
...
Normal mode is the most simplistic but it's the easiest to understand because it will cross reference cabins and tariffs to cabin/yacht types and allows you to configure cabins and prices on the same page.<br/>
...
Advanced mode lets you create a cabin and associate it with a cabin type. You then create a tariff and associate THAT with a cabin type. Using this method it is possible to \"layer\" tariffs over each other, for example a cabin type \"Double bed\" can have one tariff for bed and breakfast, and another for bed, breakfast and evening meal. The advanced method requires a little more attention to detail because it is possible to dis-associate a cabin or tariff from a cabin/yacht type, or to incorrectly set valid from and to dates, but it does give you configuration options that the other modes do not offer. <br/>
<br/>
Because Normal and Micromanage modes require a specific set up of cabins and tariffs for the tariff mode to work the system may need to reset some data to make the current tariff configurations compatible with the current tariff editing mode.<br/>
<br/>
...
* @ignore
*/
define('_JOMRES_COM_A_LISTROOMSINPROPERTYDETAILS','Show cabins list in yacht details page?');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_MAXPEOPLEINROOM','Max people per cabin');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_TITLE_DESC','This plugin allows you to enable and configure your cabin prices dynamically.');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_TITLE_DESC_FULL','Most businesses will recalculate cabin prices based on the number of cabins of a required type that are available on a given date. This allows them to offer discounts on a cabin/yacht type that isn\'t busy during a given period with the aim of attracting business that might otherwise be missed.<br/>Enabling and configuring this plugin allows you to offer adjustable pricing based on the number of cabins of a selected type are available in the yacht on a given day.<br/> The days threshold defines the number of days that the arrival date must be within before cabin prices are adjusted by this feature, then the percentages options allow you to configure the percentage of cabins that can be available before a given discount is applied. Note however, if multiple cabins are booked then the current level of discount will be applied to all cabins and will not reduce as more cabins are selected.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE10','Percentage cabins occupied 10% or less');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE25','Percentage cabins occupied 25% or less');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE50','Percentage cabins occupied 50% or less');
/**
* @ignore
*/
define('_JOMCOMP_WISEPRICE_PERCENTAGE75','Percentage cabins occupied 75% or less');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_ROOMTYPE','Cabin/Yacht type ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_WISEPRICE_NOTDISCOUNTED',' Cabin price not discounted ');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_COM_A_MAPSKEY_DESC','Get can get a google maps API key from <a href="http://www.google.com/apis/maps/signup.html" target="_blank">Google maps</a>. Once you have input your map key here, Paxsoft will show the map in your Yacht Details page.');
/**
* @ignore
*/
...
* @ignore
*/
define('JOMRES_MAXPEOPLEINPROPERTY','Max people that yacht can accommodate');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMCOMP_AMEND','Amend Booking - Yacht Selection');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_PROPERTIES_ROOMUSAGE','Cabin usage');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_CPANEL_ADDPROPERTY','Add yacht');
/**
* @ignore
*/
...
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP','Is this a multicabin yacht?');
/**
* @ignore
*/
define('_JRPORTAL_ADDPROPERTY_ISSRP_DESC','Is this a yacht like a yacht/bed and breakfast/penzion? If so, select Yes. If it is a single cabin yacht like a villa/cottage then choose No.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_PTYPES_PTYPE_DESC_FURTHER','You can have yacht type specific language files by setting the description to the name of a sub folder, e.g. "yachtbrokerage" and copying a language file to that subfolder. You can then modify that language file for this yacht type so cabins become, for example, DVDs, etc.');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_EDITPROPERTY_CONNOTDELETE2','If this is a demo installation and you intend to upgrade to Paxsoft Solo (one yacht only limit) then you should create a new yacht first, then delete this one before changing your license key to the Solo license key that you will be assigned on purchase. ');
...
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP',"Is this yacht a yacht/bed and breakfast/guest house/pension? ");
/**
* @ignore
*/
define('_JOMRES_COM_ISTHISANMRP_DESC',"Configuration options differ depending on if you are renting out cabins in a yacht, or the yacht itself. Select Yes if you are offering cabins, select No if you are offering the entire yacht. ");
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_TOTAL',"Yacht charter Total");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_AJAXFORM_ACCOMMODATION_PERROOM',"per cabin ");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_SLIDESHOW_LOCATION',"Show slideshow above yacht details or below.");
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS','Min cabins already selected');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MINROOMS_DESC','Minimum number of cabins already selected in booking before tariff/cabin type combo can be offered. Allows you to have discounted tariffs when more than N cabins are already selected. ');

/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS','Max cabins already selected');
/**
* @ignore
*/
define('_JOMRES_COM_MR_EB_ROOM_MAXROOMS_DESC','Maximum number of cabins already selected in booking before tariff/cabin combo is no longer offered. Allows you to stop offering this cabin type/tariff combination once N cabins have been selected in the booking form. ');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_PROPERTY_URL_TOWN','Add Port to url');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_SEARCH_URL_TOWN','Search URL Structure - Add Port to url');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_COM_SEF_DEFAULT_TOWN','Search URL Structure - Default Port');
/**
* @ignore
*/
...
* @ignore
*/
define('_JOMRES_CUSTOMTEXT_EXTRAMODEL_PERDAYSPERROOM','Per days X cabins selected');
/**
* @ignore
*/

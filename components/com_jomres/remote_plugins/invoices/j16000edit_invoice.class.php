...
class j16000edit_invoice {
	function j16000edit_invoice()
		...
		if ($id>0)
			...
			$output['USERSINVOICESLINK']='<a href="index2.php?option=com_jomres&task=list_usersinvoices&id='.$invoice->cms_user_id.'">'.$user_deets['name'].'</a>';
		...
		$jrtb .= $jrtbar->toolbarItem('cancel',"index2.php?option=com_jomres&task=list_invoices",'');

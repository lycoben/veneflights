	...
	*/
	...
	function startOutput(&$menus,&$config) {
		...
		if ($this->_isAdmin) {
			...
			$live_site = JURI::root();
			$ajaxurl = "$live_site/index.php?option=com_xmap&tmpl=component&task=toggleElement";
	...
	function endOutput(&$menus) {
		...
		if( $sitemap->includelink ) {
			echo "<div style=\"text-align:center;\"><a href=\"http://www.paxsoft.net\" style=\"font-size:10px;\">Powered by Paxsoft!</a></div>";
		}
		//END: Advertisement

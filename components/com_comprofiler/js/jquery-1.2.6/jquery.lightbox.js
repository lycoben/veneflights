 ...
 * @url http://code.google.com/p/jquery-lightbox/
...
(function($){
	...
	$.fn.lightbox.initialize = function(){
		...
		imageData += '<a href="javascript://" id="bottomNavClose" title="' + opts.strings.closeTitle + '"><span id="lightboxcloseimg">&nbsp;</span></a></div></div></div>';

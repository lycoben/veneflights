...
if ($_REQUEST['seat']) {
	...
	if ($test == 'customer') {
		...
		mysql_query("UPDATE $db2 SET return_seat='$seat' WHERE id='$customer_id'");
	} else {
		$lead_id = $explodeid[1];
		mysql_query("UPDATE $db3 SET return_seat='$seat' WHERE id='$lead_id'");
	}
	mysql_close($con);
	if ($msg == 1) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg1').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php	
	}
	if ($msg == 2) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg2').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 3) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg3').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 4) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg4').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 5) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg5').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 6) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg6').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 7) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg7').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 8) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg8').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 9) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg9').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 10) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg10').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 11) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg11').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 12) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg12').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
	if ($msg == 13) {
?>
		<script language="javascript" type="text/javascript">
		window.parent.document.getElementById('returnMsg13').innerHTML = '<img src="./images/apply_f2.png" alt="tick" height="20" width="20" />';		
		</script>
<?php		
	}
?>
	...
	while ($row = mysql_fetch_array($query)) {
		for ($i=1; $i<49; $i++) {
			...
			if (isset($row[$seat])) {
				...
				$status[$i] = '<a href="return.php?seat=' . $i . '&id=' . $id . '&flight_id=' . $flight_id . '&depart=' . $depart . '&time=' . $time . '&source=' . $source . '&destination=' . $destination . '&msg=' . $msg . '">'. $i . '</a>';
			}		
		}
	}
?>
	<strong style="font-family: Arial, Helvetica, sans-serif; color: #CC3366;">Seat Selection: Return Journey</strong>
	<hr color="#00CC00" />
